...
const finders: Nav[] = [
  ...
  // No-price lane: auction / tender / by-negotiation listings valued off agreeing
  // signals, ranked by buy-side headroom (estimate − walk-away ceiling).
  { href: "/auctions", label: "nav.auctions", dot: "#2563EB" },
