...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Ollie's page paints itself near-black. A pale header sitting on top of it
  // is the seam you can see from across the room.
      ...
      <aside
        style={{
          ...
          ...(isMobile
            ...
            : {
                flex: railOpen ? "0 0 264px" : "0 0 0px",
                width: railOpen ? 264 : 0,
                padding: railOpen ? "26px 20px" : "26px 0",
                overflow: "hidden",
                position: "sticky",
