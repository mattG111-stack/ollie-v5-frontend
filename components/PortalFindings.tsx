...
const FIELD: Record<string, string> = {
  ...
  // OneRoof writes to its OWN column now. third_party_valuation is the figure
  // that arrives with the weekly feed, and labelling it "OneRoof's" here is how
  // an operator ends up approving a fill from a source it did not come from.
  oneroof_valuation: "OneRoof's estimate",
  third_party_valuation: "The feed's estimate",
  pv_estimate_mid: "CoreLogic's estimate",
};
...
const MONEY = new Set([
  ...
  "oneroof_valuation", "third_party_valuation", "pv_estimate_mid",
]);
