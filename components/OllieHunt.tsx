...
const DIM = "#7E9AC0";
const FAINT = "#55708F";
const LINE = "rgba(126,154,192,.2)";
const PANEL = "rgba(16,28,49,.5)";
const SKY = "radial-gradient(120% 52% at 50% 0%, #12203A 0%, #0A1120 44%, #070B14 100%)";
        ...
        >
          <div style={{ borderRadius: 19, background: "linear-gradient(165deg, #0E2320 0%, #0A1522 100%)", padding: 20 }}>
            ...
            <div style={{ display: "flex", gap: 7, marginTop: 14, flexWrap: "wrap" }}>
              ...
              {best.is_subdividable && best.max_addl_lots ? (
...
function Heading({ children }: { children: React.ReactNode }) {
  return (
    <h2 style={{ fontSize: 33, fontWeight: 900, letterSpacing: "-.04em", lineHeight: 1.06, margin: "13px 0 0", color: "#FFFFFF" }}>
      {children}
    </h2>
  );
}
...
function Big({ children }: { children: React.ReactNode }) {
  return <div style={{ fontSize: 32, fontWeight: 900, letterSpacing: "-.04em", color: "#FFFFFF" }}>{children}</div>;
}
