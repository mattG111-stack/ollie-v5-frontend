...
import { fmtArea, fmtMoney, fmtMoneyShort } from "@/lib/format";
...
export default function DealFinder({
  ...
  const qs = useMemo(() => {
    const base: Record<string, string> = { ...filter, order_by: orderBy, order_dir: "desc" };
    ...
    return base;
  }, [filter, orderBy, search, district, suburb, minBeds, maxPrice]);
  ...
  return (
    <div style={{ padding: "34px 40px 60px", maxWidth: 1500, width: "100%" }}>
          ...
          >
            <div style={{ flex: "1 1 300px", minWidth: 0 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "16px 26px", marginTop: 26 }}>
                <HeroStat label={t("deal.listPrice")} value={fmtMoneyShort(hero.asking_price)} />
            ...
            >
              ...
              {hero.is_subdividable && hero.max_addl_lots ? (
                <span
                  style={{
                    fontFamily: MONO,
                    fontSize: 12,
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 30, flexWrap: "wrap" }}>
        ...
        <select value={district} onChange={(e) => setDistrict(e.target.value)} style={DF_SELECT}>
  ...
  return (
    ...
    >
      ...
      <div className="deal-card__figures">
        <Money label={t("deal.listPrice")} value={fmtMoneyShort(r.asking_price)} muted strike />
      ...
      <div className="deal-card__pills">
          {!leadLots && r.is_subdividable && r.max_addl_lots ? (
