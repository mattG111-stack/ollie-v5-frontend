...
function Inner() {
  ...
  async function runStage(stage: "enrich" | "price") {
    ...
    try {
      ...
      setStageMsg(`${stage === "enrich" ? "Enrich" : "Re-price"} running in the background — you can leave this page.`);
    ...
    <div className="px-4 sm:px-7 py-6">
      ...
      <div className="bg-white border border-line rounded-card shadow-soft p-4 mt-5">
        ...
        <div className="flex flex-wrap items-center gap-3 mt-3">
          ...
          <StageButton label="Re-price"
            running={starting === "price" || (stageJob?.stage === "price" && stageJob?.status === "running")}
