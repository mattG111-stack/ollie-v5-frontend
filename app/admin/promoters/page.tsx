...
function Inner() {
  ...
  return (
    <div className="px-7 py-6 max-w-6xl">
      ...
      {/* One across on a small Android. Two columns of 146px each held a money
          figure and a caption ("recorded, not yet paid") in a panel 120px tall
          — the figure is the point of the tile and it had no room left. 400px
          is where the pair stops fitting. */}
      {sum && (
        <div className="grid grid-cols-1 min-[400px]:grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
