      ...
      >
        ...
        <Card>
          ...
          {(() => {
            ...
            if (p.tm_valuation != null)
              tiles.push({
                label: t("prop.srcTrademe"), value: p.tm_valuation, provider: true,
                logo: "/logos/trademe.png",
                sub: p.tm_valuation_low != null && p.tm_valuation_high != null
                  ? `${fmtMoneyShort(p.tm_valuation_low)}–${fmtMoneyShort(p.tm_valuation_high)}`
                  : undefined,
              });
            else
