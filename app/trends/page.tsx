...
function SuburbStatsPanel({ suburb, ptype, trend }:
  ...
  return (
    <div className="bg-white border border-line rounded-card shadow-soft p-5 flex flex-col">
      ...
      {/* Two across on a phone, three from 640px. At 390px three tiles are
          110px each and "Median days to sell" wraps onto three lines, which
          makes a short label look like a paragraph. */}
