...
const STRINGS: Dict = {
  ...
  "today.historyThin": { en: "Not enough history yet — the trend appears next week.", zh: "历史数据不足——趋势将于下周显示。", ta: "போதிய வரலாறு இல்லை — போக்கு அடுத்த வாரம் தெரியும்.", gu: "પૂરતો ઇતિહાસ નથી — વલણ આવતા અઠવાડિયે દેખાશે.", pa: "ਲੋੜੀਂਦਾ ਇਤਿਹਾਸ ਨਹੀਂ — ਰੁਝਾਨ ਅਗਲੇ ਹਫ਼ਤੇ ਦਿਖੇਗਾ।", hi: "पर्याप्त इतिहास नहीं — रुझान अगले सप्ताह दिखेगा।" },
