...
const STRINGS: Dict = {
  ...
  "today.historyThin": { en: "Not enough weekly snapshots yet — the trend appears once a second week is published.", zh: "每周快照不足——发布第二周后将显示趋势。", ta: "போதுமான வாராந்திர ஸ்னாப்ஷாட்கள் இல்லை — இரண்டாவது வாரம் வெளியிடப்பட்டதும் போக்கு தோன்றும்.", gu: "હજી પૂરતા સાપ્તાહિક સ્નેપશોટ નથી — બીજું અઠવાડિયું પ્રકાશિત થતાં ટ્રેન્ડ દેખાશે.", pa: "ਹਾਲੇ ਕਾਫ਼ੀ ਹਫ਼ਤਾਵਾਰੀ ਸਨੈਪਸ਼ਾਟ ਨਹੀਂ — ਦੂਜਾ ਹਫ਼ਤਾ ਪ੍ਰਕਾਸ਼ਿਤ ਹੋਣ ਤੇ ਰੁਝਾਨ ਦਿਖੇਗਾ।", hi: "अभी पर्याप्त साप्ताहिक स्नैपशॉट नहीं — दूसरा सप्ताह प्रकाशित होते ही रुझान दिखेगा।" },
  "today.sinceFirst": { en: "since first snapshot", zh: "自首个快照以来", ta: "முதல் ஸ்னாப்ஷாட்டிலிருந்து", gu: "પ્રથમ સ્નેપશોટથી", pa: "ਪਹਿਲੇ ਸਨੈਪਸ਼ਾਟ ਤੋਂ", hi: "पहले स्नैपशॉट से" },
  ...
  "hd.topNone": { en: "Nothing in the current batch", zh: "本批次暂无", ta: "தற்போதைய தொகுப்பில் எதுவும் இல்லை", gu: "વર્તમાન બેચમાં કંઈ નથી", pa: "ਮੌਜੂਦਾ ਬੈਚ ਵਿੱਚ ਕੁਝ ਨਹੀਂ", hi: "वर्तमान बैच में कुछ नहीं" },
