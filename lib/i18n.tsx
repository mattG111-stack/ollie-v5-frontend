...
const STRINGS: Dict = {
  ...
  "today.medianDom": { en: "Median days to sell", zh: "预计售期中位数", ta: "இடைநிலை மதிப்பிடப்பட்ட விற்பனை நாட்கள்", gu: "મધ્યક અંદાજિત વેચાણ દિવસ", pa: "ਮੱਧਮਾਨ ਅਨੁਮਾਨਿਤ ਵਿਕਰੀ ਦਿਨ", hi: "मध्यक अनुमानित बिक्री दिन" },
  ...
  "hd.subdivProfit": { en: "ESTIMATED SUBDIVISION NET GAIN", zh: "可实现分割利润", ta: "கிடைக்கும் உட்பிரிவு லாபம்", gu: "ઉપલબ્ધ ઉપવિભાજન લાભ", pa: "ਉਪਲਬਧ ਉਪਵੰਡ ਲਾਭ", hi: "उपलब्ध उपविभाजन लाभ" },
  ...
  "hd.gemsHint": { en: "across {n} listings · 15%+ uplift over asking, 8+ comps", zh: "覆盖 {n} 条 · 低于估值 15%+、8+ 可比成交", ta: "{n} பட்டியல்களில் · மதிப்பை விட 15%+ குறைவு, 8+ ஒப்பீடு", gu: "{n} લિસ્ટિંગ પર · મૂલ્યથી 15%+ ઓછું, 8+ તુલના", pa: "{n} ਲਿਸਟਿੰਗਾਂ 'ਤੇ · ਮੁੱਲ ਤੋਂ 15%+ ਘੱਟ, 8+ ਤੁਲਨਾ", hi: "{n} लिस्टिंग पर · मूल्य से 15%+ कम, 8+ तुलना" },
  "hd.subdivHint": { en: "{n} potential sites · total includes modelled profitable strategies only", zh: "覆盖 {n} 处 · 未计许可与融资", ta: "{n} மனைகளில் · அனுமதி மற்றும் நிதிக்கு முன்", gu: "{n} પ્લોટ પર · મંજૂરી અને નાણાં પહેલા", pa: "{n} ਪਲਾਟਾਂ 'ਤੇ · ਮਨਜ਼ੂਰੀ ਅਤੇ ਵਿੱਤ ਤੋਂ ਪਹਿਲਾਂ", hi: "{n} प्लॉट पर · अनुमति और वित्त से पहले" },
  ...
  "hd.marginHint": { en: "across {n} listings · same quality filters as Underpriced", zh: "覆盖 {n} 条 · 含较弱信号", ta: "{n} பட்டியல்களில் · பலவீன சமிக்ஞைகளும் அடங்கும்", gu: "{n} લિસ્ટિંગ પર · નબળા સંકેત પણ સામેલ", pa: "{n} ਲਿਸਟਿੰਗਾਂ 'ਤੇ · ਕਮਜ਼ੋਰ ਸੰਕੇਤ ਵੀ ਸ਼ਾਮਲ", hi: "{n} लिस्टिंग पर · कमज़ोर संकेत भी शामिल" },
  ...
  "hd.netGain": { en: "NET GAIN", zh: "净收益", ta: "நிகர ஆதாயம்", gu: "ચોખ્ખો નફો", pa: "ਸ਼ੁੱਧ ਲਾਭ", hi: "शुद्ध लाभ" },
