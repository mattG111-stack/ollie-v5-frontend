...
const STRINGS: Dict = {
  ...
  "nav.bugLog": { en: "Bug log", zh: "问题记录", ta: "பிழை பதிவு", gu: "બગ લોગ", pa: "ਬੱਗ ਲਾਗ", hi: "बग लॉग" },
  "nav.assistantKey": { en: "Ask Ollie key", zh: "Ollie 密钥", ta: "Ollie சாவி", gu: "Ollie કી", pa: "Ollie ਕੁੰਜੀ", hi: "Ollie कुंजी" },
  "nav.mapImagery": { en: "Map imagery", zh: "地图影像", ta: "வரைபடப் படங்கள்", gu: "નકશા છબી", pa: "ਨਕਸ਼ਾ ਤਸਵੀਰਾਂ", hi: "मानचित्र चित्र" },
  "nav.promoters": { en: "Promoters", zh: "推广者", ta: "விளம்பரதாரர்கள்", gu: "પ્રમોટર્સ", pa: "ਪ੍ਰਮੋਟਰ", hi: "प्रमोटर" },
  "nav.dataProbe": { en: "Data probe", zh: "数据探测", ta: "தரவு ஆய்வு", gu: "ડેટા પ્રોબ", pa: "ਡਾਟਾ ਪੜਤਾਲ", hi: "डेटा जाँच" },
  "nav.openMenu": { en: "Open menu", zh: "打开菜单", ta: "மெனுவைத் திற", gu: "મેનુ ખોલો", pa: "ਮੀਨੂ ਖੋਲ੍ਹੋ", hi: "मेनू खोलें" },
  "nav.promoter": { en: "Promoter", zh: "推广", ta: "விளம்பரம்", gu: "પ્રમોટર", pa: "ਪ੍ਰਮੋਟਰ", hi: "प्रमोटर" },
  "nav.myReferrals": { en: "My referrals", zh: "我的推荐", ta: "என் பரிந்துரைகள்", gu: "મારા રેફરલ્સ", pa: "ਮੇਰੇ ਰੈਫਰਲ", hi: "मेरे रेफ़रल" },
  "ask.quotaLeft": { en: "{n} of {limit} questions left today", zh: "今日还剩 {n}/{limit} 次提问", ta: "இன்று {limit} இல் {n} கேள்விகள் மீதம்", gu: "આજે {limit} માંથી {n} પ્રશ્નો બાકી", pa: "ਅੱਜ {limit} ਵਿੱਚੋਂ {n} ਸਵਾਲ ਬਾਕੀ", hi: "आज {limit} में से {n} प्रश्न शेष" },
  "ask.quotaNone": { en: "You have used today's {limit} questions. They reset at midnight.", zh: "今日 {limit} 次提问已用完，午夜重置。", ta: "இன்றைய {limit} கேள்விகளை பயன்படுத்திவிட்டீர்கள். நள்ளிரவில் மீட்டமைக்கப்படும்.", gu: "તમે આજના {limit} પ્રશ્નો વાપરી નાખ્યા. મધ્યરાત્રિએ રીસેટ થશે.", pa: "ਤੁਸੀਂ ਅੱਜ ਦੇ {limit} ਸਵਾਲ ਵਰਤ ਲਏ ਹਨ। ਅੱਧੀ ਰਾਤ ਨੂੰ ਰੀਸੈੱਟ ਹੋਣਗੇ।", hi: "आपने आज के {limit} प्रश्न उपयोग कर लिए। आधी रात को रीसेट होंगे।" },
  "nav.askApex": { en: "Ask Ollie", zh: "问 Ollie", ta: "Ollie இடம் கேளுங்கள்", gu: "Ollie ને પૂછો", pa: "Ollie ਤੋਂ ਪੁੱਛੋ", hi: "Ollie से पूछें" },
  ...
  "nav.hideMenu": { en: "Hide the menu", zh: "隐藏菜单", ta: "மெனுவை மறை", gu: "મેનુ છુપાવો", pa: "ਮੀਨੂ ਲੁਕਾਓ", hi: "मेन्यू छिपाएँ" },
  "nav.whoTheyAre": { en: "Who they are", zh: "客户画像", ta: "வாடிக்கையாளர் விவரம்", gu: "ગ્રાહકો કોણ છે", pa: "ਗਾਹਕ ਕੌਣ ਹਨ", hi: "ग्राहक कौन हैं" },
  ...
  "deal.sortedByMargin": { en: "Largest value gap ($) first", zh: "按差价排序 ↓", ta: "வித்தியாசப்படி வரிசைப்படுத்தப்பட்டது ↓", gu: "તફાવત પ્રમાણે ક્રમબદ્ધ ↓", pa: "ਅੰਤਰ ਅਨੁਸਾਰ ਕ੍ਰਮਬੱਧ ↓", hi: "अंतर के अनुसार क्रमित ↓" },
  "deal.sortedByLots": { en: "Highest estimated net gain first", zh: "按地块排序 ↓", ta: "மனைகள்படி வரிசைப்படுத்தப்பட்டது ↓", gu: "લોટ પ્રમાણે ક્રમબદ્ધ ↓", pa: "ਲਾਟ ਅਨੁਸਾਰ ਕ੍ਰਮਬੱਧ ↓", hi: "लॉट के अनुसार क्रमित ↓" },
  ...
  "deal.largestSite": { en: "HIGHEST ESTIMATED NET GAIN", zh: "最大地块", ta: "பெரிய மனை", gu: "સૌથી મોટો પ્લોટ", pa: "ਸਭ ਤੋਂ ਵੱਡਾ ਪਲਾਟ", hi: "सबसे बड़ा प्लॉट" },
  ...
  "deal.buyPrice": { en: "EST. BUY PRICE", zh: "预估买入价", ta: "மதிப்பிட்ட வாங்கும் விலை", gu: "અંદાજિત ખરીદ ભાવ", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ", hi: "अनुमानित खरीद मूल्य" },
  ...
  "deal.underpricedBlurb": {
    en: "Listings flagged as underpriced, with at least 7.5% value uplift over asking and two comparable sales. Ranked by the dollar gap between asking price and estimated value.",
  ...
  "deal.subdividableBlurb": {
    en: "Potential subdivision sites from our screening model. Ranked by estimated net gain under the default cost assumptions. A flag does not establish profitability or council consent.",
  ...
  "auc.empty": { en: "No no-price listings clear the confidence gate yet.", zh: "暂无无价房源通过置信门槛。", ta: "விலை இல்லாத பட்டியல்கள் எதுவும் இன்னும் தகுதி பெறவில்லை.", gu: "કિંમત વગરની કોઈ યાદી હજી લાયક નથી.", pa: "ਕੀਮਤ ਤੋਂ ਬਿਨਾਂ ਕੋਈ ਲਿਸਟਿੰਗ ਅਜੇ ਯੋਗ ਨਹੀਂ।", hi: "बिना कीमत वाली कोई लिस्टिंग अभी योग्य नहीं।" },
  ...
  // --- ask ollie ---
  // Benefit first, machinery never. The old lede led with a caveat about how
  // the answers are produced — a "live query", "the model's memory" — which
  // is our plumbing, not the reader's reason to care.
  "ask.intro": { en: "Ask in plain English. Which suburbs are moving, what a street has been selling for, where the margin is hiding \u2014 answered from your own listings and sales, never guessed.", zh: "\u7528\u65e5\u5e38\u8bed\u8a00\u63d0\u95ee\u3002\u54ea\u4e9b\u533a\u5728\u52a8\u3001\u67d0\u6761\u8857\u6700\u8fd1\u6210\u4ea4\u591a\u5c11\u3001\u5229\u6da6\u85cf\u5728\u54ea\u91cc\u2014\u2014\u7b54\u6848\u5168\u90e8\u6765\u81ea\u4f60\u81ea\u5df1\u7684\u623f\u6e90\u4e0e\u6210\u4ea4\u8bb0\u5f55\uff0c\u7edd\u4e0d\u81c6\u6d4b\u3002", ta: "\u0b8e\u0bb3\u0bbf\u0baf \u0bae\u0bca\u0bb4\u0bbf\u0baf\u0bbf\u0bb2\u0bcd \u0b95\u0bc7\u0bb3\u0bc1\u0b99\u0bcd\u0b95\u0bb3\u0bcd. \u0b8e\u0ba8\u0bcd\u0ba4 \u0baa\u0bc1\u0bb1\u0ba8\u0b95\u0bb0\u0bcd\u0b95\u0bb3\u0bcd \u0ba8\u0b95\u0bb0\u0bcd\u0b95\u0bbf\u0ba9\u0bcd\u0bb1\u0ba9, \u0b92\u0bb0\u0bc1 \u0ba4\u0bc6\u0bb0\u0bc1 \u0b8e\u0bb5\u0bcd\u0bb5\u0bb3\u0bb5\u0bc1\u0b95\u0bcd\u0b95\u0bc1 \u0bb5\u0bbf\u0bb1\u0bcd\u0b95\u0bbf\u0bb1\u0ba4\u0bc1, \u0bb2\u0bbe\u0baa\u0bae\u0bcd \u0b8e\u0b99\u0bcd\u0b95\u0bc7 \u2014 \u0b89\u0b99\u0bcd\u0b95\u0bb3\u0bcd \u0b9a\u0bca\u0ba8\u0bcd\u0ba4 \u0baa\u0b9f\u0bcd\u0b9f\u0bbf\u0baf\u0bb2\u0bcd\u0b95\u0bb3\u0bcd \u0bae\u0bb1\u0bcd\u0bb1\u0bc1\u0bae\u0bcd \u0bb5\u0bbf\u0bb1\u0bcd\u0baa\u0ba9\u0bc8\u0b95\u0bb3\u0bbf\u0bb2\u0bcd \u0b87\u0bb0\u0bc1\u0ba8\u0bcd\u0ba4\u0bc7 \u0baa\u0ba4\u0bbf\u0bb2\u0bcd, \u0b8a\u0b95\u0bae\u0bcd \u0b85\u0bb2\u0bcd\u0bb2.", gu: "\u0ab8\u0abe\u0aa6\u0ac0 \u0aad\u0abe\u0ab7\u0abe\u0aae\u0abe\u0a82 \u0aaa\u0ac2\u0a9b\u0acb. \u0a95\u0aaf\u0abe \u0ab5\u0abf\u0ab8\u0acd\u0aa4\u0abe\u0ab0\u0acb \u0a97\u0aa4\u0abf\u0aae\u0abe\u0a82 \u0a9b\u0ac7, \u0a95\u0acb\u0a88 \u0ab6\u0ac7\u0ab0\u0ac0 \u0a95\u0ac7\u0a9f\u0ab2\u0abe\u0aae\u0abe\u0a82 \u0ab5\u0ac7\u0a9a\u0abe\u0aaf \u0a9b\u0ac7, \u0aa8\u0aab\u0acb \u0a95\u0acd\u0aaf\u0abe\u0a82 \u0a9b\u0ac1\u0aaa\u0abe\u0aaf\u0acb \u0a9b\u0ac7 \u2014 \u0a9c\u0ab5\u0abe\u0aac \u0aa4\u0aae\u0abe\u0ab0\u0ac0 \u0aaa\u0acb\u0aa4\u0abe\u0aa8\u0ac0 \u0aaf\u0abe\u0aa6\u0ac0\u0a93 \u0a85\u0aa8\u0ac7 \u0ab5\u0ac7\u0a9a\u0abe\u0aa3\u0aae\u0abe\u0a82\u0aa5\u0ac0, \u0a95\u0acd\u0aaf\u0abe\u0ab0\u0ac7\u0aaf \u0a85\u0a9f\u0a95\u0ab3\u0aa5\u0ac0 \u0aa8\u0ab9\u0abf\u0a82.", pa: "\u0a38\u0a3e\u0a26\u0a3e \u0a2d\u0a3e\u0a38\u0a3c\u0a3e \u0a35\u0a3f\u0a71\u0a1a \u0a2a\u0a41\u0a71\u0a1b\u0a4b\u0964 \u0a15\u0a3f\u0a39\u0a5c\u0a47 \u0a07\u0a32\u0a3e\u0a15\u0a47 \u0a39\u0a3f\u0a71\u0a32 \u0a30\u0a39\u0a47 \u0a39\u0a28, \u0a15\u0a4b\u0a08 \u0a17\u0a32\u0a40 \u0a15\u0a3f\u0a70\u0a28\u0a47 \u0a35\u0a3f\u0a71\u0a1a \u0a35\u0a3f\u0a15 \u0a30\u0a39\u0a40 \u0a39\u0a48, \u0a2e\u0a41\u0a28\u0a3e\u0a5e\u0a3e \u0a15\u0a3f\u0a71\u0a25\u0a47 \u0a32\u0a41\u0a15\u0a3f\u0a06 \u0a39\u0a48 \u2014 \u0a1c\u0a35\u0a3e\u0a2c \u0a24\u0a41\u0a39\u0a3e\u0a21\u0a40\u0a06\u0a02 \u0a06\u0a2a\u0a23\u0a40\u0a06\u0a02 \u0a32\u0a3f\u0a38\u0a1f\u0a3f\u0a70\u0a17\u0a3e\u0a02 \u0a05\u0a24\u0a47 \u0a35\u0a3f\u0a15\u0a30\u0a40\u0a06\u0a02 \u0a24\u0a4b\u0a02, \u0a15\u0a26\u0a47 \u0a05\u0a70\u0a26\u0a3e\u0a1c\u0a3c\u0a47 \u0a24\u0a4b\u0a02 \u0a28\u0a39\u0a40\u0a02\u0964", hi: "\u0938\u0940\u0927\u0940 \u092d\u093e\u0937\u093e \u092e\u0947\u0902 \u092a\u0942\u091b\u0947\u0902\u0964 \u0915\u094c\u0928 \u0938\u0947 \u0907\u0932\u093e\u0915\u0947 \u091a\u0932 \u0930\u0939\u0947 \u0939\u0948\u0902, \u0915\u093f\u0938\u0940 \u0917\u0932\u0940 \u092e\u0947\u0902 \u0915\u093f\u0924\u0928\u0947 \u092e\u0947\u0902 \u092c\u093f\u0915 \u0930\u0939\u093e \u0939\u0948, \u092e\u0941\u0928\u093e\u092b\u093c\u093e \u0915\u0939\u093e\u0901 \u091b\u093f\u092a\u093e \u0939\u0948 \u2014 \u091c\u0935\u093e\u092c \u0906\u092a\u0915\u0940 \u0905\u092a\u0928\u0940 \u0932\u093f\u0938\u094d\u091f\u093f\u0902\u0917 \u0914\u0930 \u092c\u093f\u0915\u094d\u0930\u0940 \u0938\u0947, \u0905\u0928\u0941\u092e\u093e\u0928 \u0938\u0947 \u0915\u092d\u0940 \u0928\u0939\u0940\u0902\u0964" },
  ...
  "ask.placeholder": { en: "Ask anything about the market\u2026", zh: "\u8be2\u95ee\u5e02\u573a\u4efb\u4f55\u95ee\u9898\u2026", ta: "\u0b9a\u0ba8\u0bcd\u0ba4\u0bc8 \u0baa\u0bb1\u0bcd\u0bb1\u0bbf \u0b8e\u0ba4\u0bc8\u0baf\u0bc1\u0bae\u0bcd \u0b95\u0bc7\u0bb3\u0bc1\u0b99\u0bcd\u0b95\u0bb3\u0bcd\u2026", gu: "\u0aac\u0a9c\u0abe\u0ab0 \u0ab5\u0abf\u0ab6\u0ac7 \u0a95\u0a82\u0a88\u0aaa\u0aa3 \u0aaa\u0ac2\u0a9b\u0acb\u2026", pa: "\u0a2c\u0a3e\u0a1c\u0a3c\u0a3e\u0a30 \u0a2c\u0a3e\u0a30\u0a47 \u0a15\u0a41\u0a1d \u0a35\u0a40 \u0a2a\u0a41\u0a71\u0a1b\u0a4b\u2026", hi: "\u092c\u093e\u091c\u093c\u093e\u0930 \u0915\u0947 \u092c\u093e\u0930\u0947 \u092e\u0947\u0902 \u0915\u0941\u091b \u092d\u0940 \u092a\u0942\u091b\u0947\u0902\u2026" },
  ...
  "ask.thinking": { en: "Ollie is thinking…", zh: "Ollie 正在思考…", ta: "Ollie சிந்திக்கிறது…", gu: "Ollie વિચારી રહ્યું છે…", pa: "Ollie ਸੋਚ ਰਿਹਾ ਹੈ…", hi: "Ollie सोच रहा है…" },
  ...
  "ask.audit": {
    en: "Every answer shows its working \u2014 open it to see the listings and sales the number came from. When the data cannot answer, Ollie says so instead of estimating.",
    zh: "\u6bcf\u4e2a\u56de\u7b54\u90fd\u9644\u5e26\u4f9d\u636e\u2014\u2014\u5c55\u5f00\u5373\u53ef\u770b\u5230\u8fd9\u4e2a\u6570\u5b57\u6765\u81ea\u54ea\u4e9b\u623f\u6e90\u4e0e\u6210\u4ea4\u3002\u82e5\u6570\u636e\u65e0\u6cd5\u56de\u7b54\uff0cOllie \u4f1a\u5982\u5b9e\u8bf4\u660e\uff0c\u800c\u4e0d\u4f1a\u4f30\u7b97\u3002", ta: "\u0b92\u0bb5\u0bcd\u0bb5\u0bca\u0bb0\u0bc1 \u0baa\u0ba4\u0bbf\u0bb2\u0bc1\u0bae\u0bcd \u0ba4\u0ba9\u0bcd \u0b86\u0ba4\u0bbe\u0bb0\u0ba4\u0bcd\u0ba4\u0bc8\u0b95\u0bcd \u0b95\u0bbe\u0b9f\u0bcd\u0b9f\u0bc1\u0b95\u0bbf\u0bb1\u0ba4\u0bc1 \u2014 \u0b8e\u0ba3\u0bcd \u0b8e\u0ba8\u0bcd\u0ba4 \u0baa\u0b9f\u0bcd\u0b9f\u0bbf\u0baf\u0bb2\u0bcd\u0b95\u0bb3\u0bcd \u0bae\u0bb1\u0bcd\u0bb1\u0bc1\u0bae\u0bcd \u0bb5\u0bbf\u0bb1\u0bcd\u0baa\u0ba9\u0bc8\u0b95\u0bb3\u0bbf\u0bb2\u0bcd \u0b87\u0bb0\u0bc1\u0ba8\u0bcd\u0ba4\u0bc1 \u0bb5\u0ba8\u0bcd\u0ba4\u0ba4\u0bc1 \u0b8e\u0ba9\u0baa\u0bcd \u0baa\u0bbe\u0bb0\u0bcd\u0b95\u0bcd\u0b95 \u0ba4\u0bbf\u0bb1\u0b95\u0bcd\u0b95\u0bb5\u0bc1\u0bae\u0bcd. \u0ba4\u0bb0\u0bb5\u0bbf\u0ba9\u0bbe\u0bb2\u0bcd \u0baa\u0ba4\u0bbf\u0bb2\u0bb3\u0bbf\u0b95\u0bcd\u0b95 \u0bae\u0bc1\u0b9f\u0bbf\u0baf\u0bbe\u0bb5\u0bbf\u0b9f\u0bcd\u0b9f\u0bbe\u0bb2\u0bcd, Ollie \u0b8a\u0b95\u0bbf\u0b95\u0bcd\u0b95\u0bbe\u0bae\u0bb2\u0bcd \u0b85\u0baa\u0bcd\u0baa\u0b9f\u0bbf\u0b9a\u0bcd \u0b9a\u0bca\u0bb2\u0bcd\u0b95\u0bbf\u0bb1\u0ba4\u0bc1.", gu: "\u0aa6\u0ab0\u0ac7\u0a95 \u0a9c\u0ab5\u0abe\u0aac \u0aaa\u0acb\u0aa4\u0abe\u0aa8\u0acb \u0a86\u0aa7\u0abe\u0ab0 \u0aa6\u0ab0\u0acd\u0ab6\u0abe\u0ab5\u0ac7 \u0a9b\u0ac7 \u2014 \u0a96\u0acb\u0ab2\u0ac0\u0aa8\u0ac7 \u0a9c\u0ac1\u0a93 \u0a95\u0ac7 \u0a86 \u0a86\u0a82\u0a95\u0aa1\u0acb \u0a95\u0a88 \u0aaf\u0abe\u0aa6\u0ac0\u0a93 \u0a85\u0aa8\u0ac7 \u0ab5\u0ac7\u0a9a\u0abe\u0aa3\u0aae\u0abe\u0a82\u0aa5\u0ac0 \u0a86\u0ab5\u0acd\u0aaf\u0acb. \u0a9c\u0acb \u0aa1\u0ac7\u0a9f\u0abe \u0a9c\u0ab5\u0abe\u0aac \u0aa8 \u0a86\u0aaa\u0ac0 \u0ab6\u0a95\u0ac7, \u0aa4\u0acb Ollie \u0a85\u0a82\u0aa6\u0abe\u0a9c \u0ab2\u0a97\u0abe\u0ab5\u0ab5\u0abe\u0aa8\u0ac7 \u0aac\u0aa6\u0ab2\u0ac7 \u0a8f\u0aae \u0a95\u0ab9\u0ac0 \u0aa6\u0ac7 \u0a9b\u0ac7.", pa: "\u0a39\u0a30 \u0a1c\u0a35\u0a3e\u0a2c \u0a06\u0a2a\u0a23\u0a3e \u0a06\u0a27\u0a3e\u0a30 \u0a26\u0a3f\u0a16\u0a3e\u0a09\u0a02\u0a26\u0a3e \u0a39\u0a48 \u2014 \u0a16\u0a4b\u0a32\u0a4d\u0a39 \u0a15\u0a47 \u0a35\u0a47\u0a16\u0a4b \u0a15\u0a3f \u0a07\u0a39 \u0a05\u0a70\u0a15\u0a5c\u0a3e \u0a15\u0a3f\u0a39\u0a5c\u0a40\u0a06\u0a02 \u0a32\u0a3f\u0a38\u0a1f\u0a3f\u0a70\u0a17\u0a3e\u0a02 \u0a05\u0a24\u0a47 \u0a35\u0a3f\u0a15\u0a30\u0a40\u0a06\u0a02 \u0a24\u0a4b\u0a02 \u0a06\u0a07\u0a06\u0964 \u0a1c\u0a47 \u0a21\u0a3e\u0a1f\u0a3e \u0a1c\u0a35\u0a3e\u0a2c \u0a28\u0a39\u0a40\u0a02 \u0a26\u0a47 \u0a38\u0a15\u0a26\u0a3e, \u0a24\u0a3e\u0a02 Ollie \u0a05\u0a70\u0a26\u0a3e\u0a1c\u0a3c\u0a3e \u0a32\u0a3e\u0a09\u0a23 \u0a26\u0a40 \u0a2c\u0a1c\u0a3e\u0a0f \u0a07\u0a39 \u0a15\u0a39\u0a3f \u0a26\u0a47\u0a35\u0a47\u0a17\u0a3e\u0964", hi: "\u0939\u0930 \u091c\u0935\u093e\u092c \u0905\u092a\u0928\u093e \u0906\u0927\u093e\u0930 \u0926\u093f\u0916\u093e\u0924\u093e \u0939\u0948 \u2014 \u0916\u094b\u0932\u0915\u0930 \u0926\u0947\u0916\u0947\u0902 \u0915\u093f \u092f\u0939 \u0906\u0902\u0915\u0921\u093c\u093e \u0915\u093f\u0928 \u0932\u093f\u0938\u094d\u091f\u093f\u0902\u0917 \u0914\u0930 \u092c\u093f\u0915\u094d\u0930\u093f\u092f\u094b\u0902 \u0938\u0947 \u0906\u092f\u093e\u0964 \u091c\u092c \u0921\u0947\u091f\u093e \u091c\u0935\u093e\u092c \u0928\u0939\u0940\u0902 \u0926\u0947 \u0938\u0915\u0924\u093e, Ollie \u0905\u0928\u0941\u092e\u093e\u0928 \u0932\u0917\u093e\u0928\u0947 \u0915\u0947 \u092c\u091c\u093e\u092f \u092f\u0939\u0940 \u0915\u0939\u0924\u093e \u0939\u0948\u0964",
  },

  // --- what are you hunting (asked inside Ollie, re-checked every fortnight) ---
  // Deliberately plain: this is Ollie talking, not a form. No thresholds, no
  // data sources, no internal vocabulary — the customer is told what they get,
  // never how we do it.
  "orb.ready": { en: "Ask me anything about the market.", zh: "关于市场，尽管问我。", ta: "சந்தை பற்றி எதையும் கேளுங்கள்.", gu: "બજાર વિશે કંઈપણ પૂછો.", pa: "ਬਾਜ਼ਾਰ ਬਾਰੇ ਕੁਝ ਵੀ ਪੁੱਛੋ।", hi: "बाज़ार के बारे में कुछ भी पूछें।" },
  "hunt.eyebrow": { en: "FIRST TIME IN", zh: "首次进入", ta: "முதல் முறை", gu: "પ્રથમ વખત", pa: "ਪਹਿਲੀ ਵਾਰ", hi: "पहली बार" },
  "hunt.title": { en: "What am I looking for?", zh: "我该替你找什么？", ta: "நான் எதைத் தேட வேண்டும்?", gu: "હું શું શોધું?", pa: "ਮੈਂ ਕੀ ਲੱਭਾਂ?", hi: "मैं क्या ढूँढूँ?" },
  "hunt.intro": {
    en: "Tell me once and I'll watch for it every day — and lead with it whenever you open me.",
    zh: "告诉我一次，我每天都会替你留意，并在你打开时优先呈现。",
    ta: "ஒரு முறை சொல்லுங்கள் — தினமும் கவனித்து, நீங்கள் திறக்கும்போது முதலில் காட்டுவேன்.",
    gu: "એક વાર કહો — હું રોજ ધ્યાન રાખીશ અને તમે ખોલો ત્યારે પહેલાં એ જ બતાવીશ.",
    pa: "ਇੱਕ ਵਾਰ ਦੱਸੋ — ਮੈਂ ਹਰ ਰੋਜ਼ ਨਜ਼ਰ ਰੱਖਾਂਗਾ ਅਤੇ ਤੁਸੀਂ ਖੋਲ੍ਹਦੇ ਸਾਰ ਉਹੀ ਪਹਿਲਾਂ ਦਿਖਾਵਾਂਗਾ।",
    hi: "एक बार बता दें — मैं रोज़ नज़र रखूँगा और जब आप खोलेंगे तो वही सबसे पहले दिखाऊँगा।",
  },
  "hunt.pickMany": { en: "Pick as many as you like.", zh: "可多选。", ta: "விரும்பியவற்றைத் தேர்வுசெய்யுங்கள்.", gu: "તમને ગમે તેટલા પસંદ કરો.", pa: "ਜਿੰਨੇ ਚਾਹੋ ਚੁਣੋ।", hi: "जितने चाहें चुनें।" },
  "hunt.goal.underpriced": { en: "Priced under the market", zh: "低于市场价", ta: "சந்தை விலைக்குக் கீழே", gu: "બજારભાવથી નીચે", pa: "ਬਾਜ਼ਾਰ ਭਾਅ ਤੋਂ ਹੇਠਾਂ", hi: "बाज़ार भाव से नीचे" },
  "hunt.goal.underpriced.sub": { en: "Worth more than they're asking.", zh: "价值高于要价。", ta: "கேட்கும் விலையை விட மதிப்பு அதிகம்.", gu: "માગ્યા ભાવ કરતાં વધુ કિંમતી.", pa: "ਮੰਗੇ ਭਾਅ ਨਾਲੋਂ ਵੱਧ ਕੀਮਤੀ।", hi: "माँगे गए दाम से ज़्यादा कीमती।" },
  "hunt.goal.subdividable": { en: "Land I can split", zh: "可分割的土地", ta: "பிரிக்கக்கூடிய நிலம்", gu: "વિભાજી શકાય તેવી જમીન", pa: "ਵੰਡਣਯੋਗ ਜ਼ਮੀਨ", hi: "बाँटी जा सकने वाली ज़मीन" },
  "hunt.goal.subdividable.sub": { en: "Sites that take two titles or more.", zh: "可做两块或更多产权。", ta: "இரண்டு அல்லது அதற்கு மேற்பட்ட பட்டாக்கள்.", gu: "બે કે વધુ ટાઇટલ થાય તેવી જગ્યા.", pa: "ਦੋ ਜਾਂ ਵੱਧ ਟਾਈਟਲ ਬਣ ਸਕਣ ਵਾਲੀ ਥਾਂ।", hi: "दो या अधिक टाइटल बन सकें ऐसी जगह।" },
  "hunt.goal.cashflow": { en: "Rent that covers the loan", zh: "租金覆盖贷款", ta: "கடனை ஈடுசெய்யும் வாடகை", gu: "લોન ભરે તેવું ભાડું", pa: "ਕਰਜ਼ਾ ਪੂਰਾ ਕਰਨ ਵਾਲਾ ਕਿਰਾਇਆ", hi: "क़र्ज़ चुकाने लायक किराया" },
  "hunt.goal.cashflow.sub": { en: "Cashflow positive from day one.", zh: "第一天就有正现金流。", ta: "முதல் நாளிலிருந்தே நேர்மறை பணப்புழக்கம்.", gu: "પહેલા દિવસથી પોઝિટિવ કેશફ્લો.", pa: "ਪਹਿਲੇ ਦਿਨ ਤੋਂ ਸਕਾਰਾਤਮਕ ਨਕਦੀ।", hi: "पहले दिन से सकारात्मक नकदी।" },
  "hunt.goal.live_in": { en: "Somewhere to live", zh: "自住的家", ta: "வசிக்க ஒரு இடம்", gu: "રહેવા માટેનું ઘર", pa: "ਰਹਿਣ ਲਈ ਘਰ", hi: "रहने के लिए घर" },
  "hunt.goal.live_in.sub": { en: "A home first, an investment second.", zh: "先是家，其次才是投资。", ta: "முதலில் வீடு, பிறகு முதலீடு.", gu: "પહેલાં ઘર, પછી રોકાણ.", pa: "ਪਹਿਲਾਂ ਘਰ, ਫਿਰ ਨਿਵੇਸ਼।", hi: "पहले घर, फिर निवेश।" },
  "hunt.next": { en: "Next — where?", zh: "下一步：在哪里？", ta: "அடுத்து — எங்கே?", gu: "આગળ — ક્યાં?", pa: "ਅੱਗੇ — ਕਿੱਥੇ?", hi: "आगे — कहाँ?" },
  "hunt.skip": { en: "Skip — just show me everything", zh: "跳过，直接看全部", ta: "தவிர் — அனைத்தையும் காட்டு", gu: "છોડો — બધું જ બતાવો", pa: "ਛੱਡੋ — ਸਭ ਕੁਝ ਦਿਖਾਓ", hi: "छोड़ें — सब कुछ दिखाएँ" },
  "hunt.back": { en: "Back", zh: "返回", ta: "பின்", gu: "પાછળ", pa: "ਪਿੱਛੇ", hi: "पीछे" },
  "hunt.whereTitle": { en: "Where do you want to buy?", zh: "你想在哪里买？", ta: "எங்கே வாங்க விரும்புகிறீர்கள்?", gu: "તમે ક્યાં ખરીદવા માગો છો?", pa: "ਤੁਸੀਂ ਕਿੱਥੇ ਖਰੀਦਣਾ ਚਾਹੁੰਦੇ ਹੋ?", hi: "आप कहाँ खरीदना चाहते हैं?" },
  "hunt.whereIntro": {
    en: "Pick a few. Leave it empty and I'll watch all of Auckland.",
    zh: "选几个即可。留空则我会关注整个奥克兰。",
    ta: "சிலவற்றைத் தேர்வுசெய்யுங்கள். காலியாக விட்டால் ஆக்லாந்து முழுவதையும் கவனிப்பேன்.",
    gu: "થોડા પસંદ કરો. ખાલી રાખશો તો હું આખા ઑકલૅન્ડ પર નજર રાખીશ.",
    pa: "ਕੁਝ ਚੁਣੋ। ਖਾਲੀ ਛੱਡੋਗੇ ਤਾਂ ਮੈਂ ਪੂਰੇ ਆਕਲੈਂਡ 'ਤੇ ਨਜ਼ਰ ਰੱਖਾਂਗਾ।",
    hi: "कुछ चुनें। खाली छोड़ेंगे तो मैं पूरे ऑकलैंड पर नज़र रखूँगा।",
  },
  "hunt.budget": { en: "AND WHAT ARE YOU SPENDING?", zh: "预算是多少？", ta: "உங்கள் பட்ஜெட் என்ன?", gu: "તમારું બજેટ કેટલું?", pa: "ਤੁਹਾਡਾ ਬਜਟ ਕਿੰਨਾ?", hi: "आपका बजट कितना है?" },
  "hunt.beds": { en: "AT LEAST", zh: "最少卧室", ta: "குறைந்தபட்சம்", gu: "ઓછામાં ઓછા", pa: "ਘੱਟੋ-ਘੱਟ", hi: "कम से कम" },
  "hunt.bedsAny": { en: "Any", zh: "不限", ta: "எதுவும்", gu: "કોઈપણ", pa: "ਕੋਈ ਵੀ", hi: "कोई भी" },
  "hunt.inRange": {
    en: "{n} of the listings I watch sit in that range.",
    zh: "我关注的房源中有 {n} 套落在这个区间。",
    ta: "நான் கவனிக்கும் பட்டியல்களில் {n} இந்த வரம்பில் உள்ளன.",
    gu: "હું જે યાદીઓ જોઉં છું તેમાંથી {n} આ રેન્જમાં છે.",
    pa: "ਮੈਂ ਜੋ ਲਿਸਟਿੰਗਾਂ ਵੇਖਦਾ ਹਾਂ, ਉਹਨਾਂ ਵਿੱਚੋਂ {n} ਇਸ ਰੇਂਜ ਵਿੱਚ ਹਨ।",
    hi: "मैं जो लिस्टिंग देखता हूँ उनमें से {n} इस दायरे में हैं।",
  },
  "hunt.done": { en: "That's me — what have you got?", zh: "就这些，有什么给我？", ta: "அவ்வளவுதான் — என்ன இருக்கிறது?", gu: "બસ એટલું — તમારી પાસે શું છે?", pa: "ਬਸ ਏਨਾ — ਤੁਹਾਡੇ ਕੋਲ ਕੀ ਹੈ?", hi: "बस इतना — आपके पास क्या है?" },
  "hunt.saving": { en: "Saving…", zh: "保存中…", ta: "சேமிக்கிறது…", gu: "સાચવી રહ્યું છે…", pa: "ਸੰਭਾਲ ਰਿਹਾ ਹੈ…", hi: "सहेजा जा रहा है…" },
  "hunt.readyEyebrow": { en: "THEN HERE'S YOUR MARKET", zh: "这就是你的市场", ta: "இதுதான் உங்கள் சந்தை", gu: "તો આ રહ્યું તમારું બજાર", pa: "ਤਾਂ ਇਹ ਹੈ ਤੁਹਾਡਾ ਬਾਜ਼ਾਰ", hi: "तो यह है आपका बाज़ार" },
  "hunt.readyTitle": {
    en: "{n} of them fit you this morning.",
    zh: "今早有 {n} 套符合你的条件。",
    ta: "இன்று காலை {n} உங்களுக்குப் பொருந்துகின்றன.",
    gu: "આજે સવારે {n} તમને બંધબેસે છે.",
    pa: "ਅੱਜ ਸਵੇਰੇ {n} ਤੁਹਾਡੇ ਮੁਤਾਬਕ ਹਨ।",
    hi: "आज सुबह {n} आपके अनुकूल हैं।",
  },
  "hunt.readyNone": {
    en: "Nothing fits that today. Widen it a little and I'll look again.",
    zh: "今天没有符合的。放宽一点，我再找一次。",
    ta: "இன்று எதுவும் பொருந்தவில்லை. சற்று விரிவாக்கினால் மீண்டும் தேடுவேன்.",
    gu: "આજે કંઈ બંધબેસતું નથી. થોડું પહોળું કરો, હું ફરી જોઈશ.",
    pa: "ਅੱਜ ਕੁਝ ਨਹੀਂ ਮਿਲਿਆ। ਥੋੜ੍ਹਾ ਖੁੱਲ੍ਹਾ ਕਰੋ, ਮੈਂ ਫਿਰ ਵੇਖਾਂਗਾ।",
    hi: "आज कुछ भी मेल नहीं खाता। थोड़ा चौड़ा करें, मैं फिर देखूँगा।",
  },
  "hunt.readySplit": {
    en: "{n} of them are also splittable.",
    zh: "其中 {n} 套还可分割。",
    ta: "அவற்றில் {n} பிரிக்கவும் கூடியவை.",
    gu: "તેમાંથી {n} વિભાજી પણ શકાય છે.",
    pa: "ਉਹਨਾਂ ਵਿੱਚੋਂ {n} ਵੰਡੀਆਂ ਵੀ ਜਾ ਸਕਦੀਆਂ ਹਨ।",
    hi: "उनमें से {n} बाँटी भी जा सकती हैं।",
  },
  "hunt.readyBest": {
    en: "The best one is {amount} under what I'd value it at.",
    zh: "最好的一套比我的估值低 {amount}。",
    ta: "சிறந்தது என் மதிப்பீட்டை விட {amount} குறைவு.",
    gu: "શ્રેષ્ઠ એક મારા મૂલ્યાંકનથી {amount} ઓછું છે.",
    pa: "ਸਭ ਤੋਂ ਵਧੀਆ ਮੇਰੇ ਮੁੱਲਾਂਕਣ ਤੋਂ {amount} ਘੱਟ ਹੈ।",
    hi: "सबसे अच्छा मेरे मूल्यांकन से {amount} कम है।",
  },
  "hunt.fromNow": { en: "FROM NOW ON", zh: "从现在起", ta: "இனிமேல்", gu: "હવેથી", pa: "ਹੁਣ ਤੋਂ", hi: "अब से" },
  "hunt.promise": {
    en: "I'll open on your areas, lead with the biggest gain, and tell you the moment something new lands under your number.",
    zh: "我会以你的区域为起点，优先展示收益最大的，并在有新房源低于你的价位时立刻告诉你。",
    ta: "உங்கள் பகுதிகளுடன் தொடங்கி, மிகப்பெரிய லாபத்தை முதலில் காட்டி, உங்கள் விலைக்குக் கீழே புதியது வந்தால் உடனே சொல்வேன்.",
    gu: "હું તમારા વિસ્તારોથી શરૂ કરીશ, સૌથી મોટો ફાયદો પહેલાં બતાવીશ, અને તમારી કિંમતથી નીચે નવું આવે કે તરત કહીશ.",
    pa: "ਮੈਂ ਤੁਹਾਡੇ ਇਲਾਕਿਆਂ ਤੋਂ ਸ਼ੁਰੂ ਕਰਾਂਗਾ, ਸਭ ਤੋਂ ਵੱਡਾ ਲਾਭ ਪਹਿਲਾਂ ਵਿਖਾਵਾਂਗਾ, ਅਤੇ ਤੁਹਾਡੀ ਕੀਮਤ ਤੋਂ ਹੇਠਾਂ ਕੁਝ ਨਵਾਂ ਆਉਂਦੇ ਸਾਰ ਦੱਸਾਂਗਾ।",
    hi: "मैं आपके इलाकों से शुरू करूँगा, सबसे बड़ा फ़ायदा पहले दिखाऊँगा, और आपकी कीमत से नीचे कुछ नया आते ही बताऊँगा।",
  },
  "hunt.fortnight": {
    en: "In a fortnight I'll check none of this has changed.",
    zh: "两周后我会确认这些是否有变化。",
    ta: "இரண்டு வாரங்களில் இதில் மாற்றம் இல்லையா என்று கேட்பேன்.",
    gu: "બે અઠવાડિયામાં હું ખાતરી કરીશ કે કંઈ બદલાયું નથી.",
    pa: "ਦੋ ਹਫ਼ਤਿਆਂ ਵਿੱਚ ਮੈਂ ਪੁੱਛਾਂਗਾ ਕਿ ਕੁਝ ਬਦਲਿਆ ਤਾਂ ਨਹੀਂ।",
    hi: "दो हफ़्ते में मैं पूछूँगा कि कुछ बदला तो नहीं।",
  },
  "hunt.showAll": { en: "Show me all {n}", zh: "查看全部 {n} 套", ta: "அனைத்து {n} ஐயும் காட்டு", gu: "બધા {n} બતાવો", pa: "ਸਾਰੇ {n} ਵਿਖਾਓ", hi: "सभी {n} दिखाएँ" },
  "hunt.takeMe": { en: "Take me to them", zh: "带我去看", ta: "என்னை அங்கே அழைத்துச் செல்", gu: "મને ત્યાં લઈ જાઓ", pa: "ਮੈਨੂੰ ਉੱਥੇ ਲੈ ਚੱਲੋ", hi: "मुझे वहाँ ले चलें" },
  "hunt.widen": { en: "Let me widen it", zh: "放宽条件", ta: "வரம்பை விரிவாக்கு", gu: "થોડું પહોળું કરું", pa: "ਥੋੜ੍ਹਾ ਖੁੱਲ੍ਹਾ ਕਰਾਂ", hi: "थोड़ा चौड़ा करूँ" },
  "hunt.change": { en: "Change what I'm watching", zh: "修改我的关注条件", ta: "நான் கவனிப்பதை மாற்று", gu: "હું શું જોઉં તે બદલો", pa: "ਮੈਂ ਕੀ ਵੇਖਦਾ ਹਾਂ, ਬਦਲੋ", hi: "मैं क्या देखता हूँ, बदलें" },
  "hunt.startAsking": { en: "Ask me something", zh: "问我点什么", ta: "என்னிடம் கேளுங்கள்", gu: "મને કંઈક પૂછો", pa: "ਮੈਨੂੰ ਕੁਝ ਪੁੱਛੋ", hi: "मुझसे कुछ पूछें" },

  // --- the fortnightly check ---
  "checkin.eyebrow": { en: "BEFORE I SHOW YOU TODAY", zh: "在看今天之前", ta: "இன்றைய பட்டியலுக்கு முன்", gu: "આજનું બતાવું તે પહેલાં", pa: "ਅੱਜ ਦਾ ਵਿਖਾਉਣ ਤੋਂ ਪਹਿਲਾਂ", hi: "आज का दिखाने से पहले" },
  "checkin.title": { en: "Still after the same thing?", zh: "还是找同样的吗？", ta: "இன்னும் அதையேதான் தேடுகிறீர்களா?", gu: "હજી એ જ શોધો છો?", pa: "ਹਾਲੇ ਵੀ ਉਹੀ ਲੱਭ ਰਹੇ ਹੋ?", hi: "अब भी वही खोज रहे हैं?" },
  "checkin.confirm": { en: "Nothing's changed — carry on", zh: "没有变化，继续", ta: "மாற்றமில்லை — தொடரவும்", gu: "કંઈ બદલાયું નથી — ચાલુ રાખો", pa: "ਕੁਝ ਨਹੀਂ ਬਦਲਿਆ — ਜਾਰੀ ਰੱਖੋ", hi: "कुछ नहीं बदला — जारी रखें" },
  "checkin.update": { en: "Actually, a few things have", zh: "其实有些变了", ta: "உண்மையில், சில மாறியுள்ளன", gu: "ખરેખર, થોડું બદલાયું છે", pa: "ਅਸਲ ਵਿੱਚ, ਕੁਝ ਬਦਲਿਆ ਹੈ", hi: "दरअसल, कुछ बदला है" },
  "checkin.snooze": { en: "Ask me again in a month", zh: "一个月后再问我", ta: "ஒரு மாதத்தில் மீண்டும் கேளுங்கள்", gu: "એક મહિના પછી ફરી પૂછો", pa: "ਇੱਕ ਮਹੀਨੇ ਬਾਅਦ ਫਿਰ ਪੁੱਛੋ", hi: "एक महीने बाद फिर पूछें" },
  "checkin.anywhere": { en: "Anywhere in Auckland", zh: "奥克兰任何地区", ta: "ஆக்லாந்தில் எங்கும்", gu: "ઑકલૅન્ડમાં ક્યાંય પણ", pa: "ਆਕਲੈਂਡ ਵਿੱਚ ਕਿਤੇ ਵੀ", hi: "ऑकलैंड में कहीं भी" },
  "checkin.anyBudget": { en: "Any budget", zh: "不限预算", ta: "எந்த பட்ஜெட்டும்", gu: "કોઈપણ બજેટ", pa: "ਕੋਈ ਵੀ ਬਜਟ", hi: "कोई भी बजट" },
  "checkin.anyGoal": { en: "Anything worth a look", zh: "任何值得一看的", ta: "பார்க்கத்தக்க எதுவும்", gu: "જોવા જેવું કંઈપણ", pa: "ਵੇਖਣ ਯੋਗ ਕੁਝ ਵੀ", hi: "देखने लायक कुछ भी" },
  "checkin.edit": { en: "Edit", zh: "修改", ta: "திருத்து", gu: "સંપાદિત", pa: "ਸੋਧੋ", hi: "बदलें" },

  // --- property detail ---
  "prop.buyPrice": { en: "EST. BUY PRICE", zh: "预估买入价", ta: "மதிப்பிட்ட வாங்கும் விலை", gu: "અંદાજિત ખરીદ ભાવ", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ", hi: "अनुमानित खरीद मूल्य" },
  ...
  // Shown under the price on a listing whose vendor has withdrawn theirs. It
  // states a fact about the listing — what it was advertised at, and when — so
  // the figure beside it is never mistaken for one the vendor is naming today.
  "prop.wasListedAt": { en: "Listed at {v} on {d}, now by negotiation", zh: "{d} 标价 {v}，现为面议", ta: "{d} அன்று {v} என பட்டியலிடப்பட்டது, இப்போது பேச்சுவார்த்தை", gu: "{d} ના રોજ {v} માં યાદીબદ્ધ, હવે વાટાઘાટ દ્વારા", pa: "{d} ਨੂੰ {v} ਵਿੱਚ ਸੂਚੀਬੱਧ, ਹੁਣ ਗੱਲਬਾਤ ਦੁਆਰਾ", hi: "{d} को {v} में सूचीबद्ध, अब बातचीत द्वारा" },
  "prop.byNegotiation": { en: "By negotiation", zh: "面议", ta: "பேச்சுவார்த்தை மூலம்", gu: "વાટાઘાટ દ્વારા", pa: "ਗੱਲਬਾਤ ਦੁਆਰਾ", hi: "बातचीत द्वारा" },
  "prop.listPrice": { en: "List price", zh: "标价", ta: "பட்டியல் விலை", gu: "યાદી કિંમત", pa: "ਸੂਚੀ ਮੁੱਲ", hi: "सूची मूल्य" },
  "prop.buyPriceRow": { en: "Est. buy price", zh: "预估买入价", ta: "மதிப்பிட்ட வாங்கும் விலை", gu: "અંદાજિત ખરીદ ભાવ", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ", hi: "अनुमानित खरीद मूल्य" },
  ...
  "sun.title": { en: "Sun & shade", zh: "日照与阴影", ta: "வெயில் & நிழல்", gu: "તડકો અને છાંયો", pa: "ਧੁੱਪ ਅਤੇ ਛਾਂ", hi: "धूप और छाया" },
  "sun.blurb": {
    en: "Drag the clock to watch the sun move over this property and see which way the shadows fall. In New Zealand the sun tracks through the north, so a north aspect is the one that gets the light.",
    zh: "拖动时钟即可查看太阳如何经过该房产，以及阴影落在哪一侧。在新西兰，太阳自北侧经过，因此朝北的一面采光最好。",
    ta: "இந்த சொத்தின் மீது சூரியன் நகர்வதையும் நிழல்கள் எந்தப் பக்கம் விழுகின்றன என்பதையும் காண கடிகாரத்தை இழுக்கவும். நியூசிலாந்தில் சூரியன் வடக்கு வழியாகச் செல்கிறது, எனவே வடக்கு முகப்பே வெளிச்சம் பெறுகிறது.",
    gu: "આ મિલકત પર સૂર્ય કેવી રીતે ફરે છે અને પડછાયા કઈ બાજુ પડે છે તે જોવા ઘડિયાળ ખેંચો. ન્યુઝીલેન્ડમાં સૂર્ય ઉત્તર તરફથી પસાર થાય છે, તેથી ઉત્તર બાજુને પ્રકાશ મળે છે.",
    pa: "ਇਸ ਜਾਇਦਾਦ ਉੱਤੇ ਸੂਰਜ ਦੀ ਚਾਲ ਅਤੇ ਪਰਛਾਵੇਂ ਕਿਸ ਪਾਸੇ ਪੈਂਦੇ ਹਨ, ਵੇਖਣ ਲਈ ਘੜੀ ਨੂੰ ਖਿੱਚੋ। ਨਿਊਜ਼ੀਲੈਂਡ ਵਿੱਚ ਸੂਰਜ ਉੱਤਰ ਵੱਲੋਂ ਲੰਘਦਾ ਹੈ, ਇਸ ਲਈ ਉੱਤਰੀ ਪਾਸੇ ਨੂੰ ਰੌਸ਼ਨੀ ਮਿਲਦੀ ਹੈ।",
    hi: "इस संपत्ति पर सूर्य की चाल और छाया किस ओर पड़ती है, देखने के लिए घड़ी खींचें। न्यूज़ीलैंड में सूर्य उत्तर से होकर गुजरता है, इसलिए उत्तर दिशा को ही रोशनी मिलती है।",
  },
  "sun.note": {
    en: "Calculated from this property's exact coordinates \u2014 sunrise, sunset and sun height are accurate to about a minute. Shadow lengths assume flat ground and a wall of the stated height; they do not account for neighbouring buildings, trees or slope.",
    zh: "根据该房产的精确坐标计算——日出、日落与太阳高度精确到约一分钟。阴影长度假设地面平坦且墙高如上，未计入邻近建筑、树木或坡度。",
    ta: "இந்தச் சொத்தின் சரியான ஆயத்தொலைவுகளிலிருந்து கணக்கிடப்பட்டது — சூரிய உதயம், அஸ்தமனம், உயரம் ஏறக்குறைய ஒரு நிமிடம் வரை துல்லியம். நிழல் நீளம் தட்டையான தரையையும் குறிப்பிட்ட உயர சுவரையும் அனுமானிக்கிறது; அண்டை கட்டிடங்கள், மரங்கள் அல்லது சாய்வு கணக்கிடப்படவில்லை.",
    gu: "આ મિલકતના ચોક્કસ કોઓર્ડિનેટ્સથી ગણતરી — સૂર્યોદય, સૂર્યાસ્ત અને ઊંચાઈ લગભગ એક મિનિટ સુધી સચોટ. પડછાયાની લંબાઈ સપાટ જમીન અને દર્શાવેલ ઊંચાઈની દીવાલ ધારે છે; પડોશી ઇમારતો, વૃક્ષો કે ઢાળ ગણતરીમાં નથી.",
    pa: "ਇਸ ਜਾਇਦਾਦ ਦੇ ਸਹੀ ਕੋਆਰਡੀਨੇਟਸ ਤੋਂ ਗਣਨਾ — ਸੂਰਜ ਚੜ੍ਹਨ, ਡੁੱਬਣ ਅਤੇ ਉਚਾਈ ਲਗਭਗ ਇੱਕ ਮਿੰਟ ਤੱਕ ਸਹੀ। ਪਰਛਾਵੇਂ ਦੀ ਲੰਬਾਈ ਪੱਧਰੀ ਜ਼ਮੀਨ ਅਤੇ ਦੱਸੀ ਉਚਾਈ ਦੀ ਕੰਧ ਮੰਨਦੀ ਹੈ; ਗੁਆਂਢੀ ਇਮਾਰਤਾਂ, ਰੁੱਖ ਜਾਂ ਢਲਾਣ ਸ਼ਾਮਲ ਨਹੀਂ।",
    hi: "इस संपत्ति के सटीक निर्देशांक से गणना — सूर्योदय, सूर्यास्त और ऊँचाई लगभग एक मिनट तक सटीक। छाया की लंबाई समतल ज़मीन और बताई गई ऊँचाई की दीवार मानती है; पड़ोसी इमारतें, पेड़ या ढलान शामिल नहीं।",
  },
  ...
  "prop.schools": { en: "Schools", zh: "学校", ta: "பள்ளிகள்", gu: "શાળાઓ", pa: "ਸਕੂਲ", hi: "स्कूल" },
  "prop.schoolsSub": { en: "This address is in zone for the schools marked below.", zh: "本地址属于下方标记学校的校区。", ta: "இந்த முகவரி கீழே குறிக்கப்பட்ட பள்ளிகளின் வலயத்தில் உள்ளது.", gu: "આ સરનામું નીચે ચિહ્નિત શાળાઓના ઝોનમાં છે.", pa: "ਇਹ ਪਤਾ ਹੇਠਾਂ ਨਿਸ਼ਾਨਬੱਧ ਸਕੂਲਾਂ ਦੇ ਜ਼ੋਨ ਵਿੱਚ ਹੈ।", hi: "यह पता नीचे चिह्नित स्कूलों के ज़ोन में है।" },
  "prop.schoolsSubNone": { en: "The closest schools to this address.", zh: "距本地址最近的学校。", ta: "இந்த முகவரிக்கு அருகிலுள்ள பள்ளிகள்.", gu: "આ સરનામાની સૌથી નજીકની શાળાઓ.", pa: "ਇਸ ਪਤੇ ਦੇ ਸਭ ਤੋਂ ਨੇੜਲੇ ਸਕੂਲ।", hi: "इस पते के सबसे नज़दीकी स्कूल।" },
  "prop.inZone": { en: "In zone", zh: "在校区内", ta: "வலயத்தில்", gu: "ઝોનમાં", pa: "ਜ਼ੋਨ ਵਿੱਚ", hi: "ज़ोन में" },
  "prop.alsoNearby": { en: "Also nearby", zh: "附近其他", ta: "அருகிலும் உள்ளன", gu: "નજીકમાં અન્ય", pa: "ਨੇੜੇ ਹੋਰ", hi: "आसपास अन्य" },
  "prop.schoolsAll": { en: "Show all {n}", zh: "显示全部 {n} 所", ta: "அனைத்து {n} ஐயும் காட்டு", gu: "બધી {n} બતાવો", pa: "ਸਾਰੇ {n} ਵੇਖੋ", hi: "सभी {n} दिखाएँ" },
  "prop.schoolsFewer": { en: "Show fewer", zh: "收起", ta: "குறைவாகக் காட்டு", gu: "ઓછું બતાવો", pa: "ਘੱਟ ਵੇਖੋ", hi: "कम दिखाएँ" },
  ...
  "prop.weeklySnapshots": { en: "Price history", zh: "价格记录", ta: "விலை வரலாறு", gu: "કિંમત ઇતિહાસ", pa: "ਕੀਮਤ ਇਤਿਹਾਸ", hi: "मूल्य इतिहास" },
  ...
  "prop.snapshotNote": { en: "No price changes recorded yet — this is the first week we have seen this listing. Any move will show here.", zh: "暂无价格变动记录——本周首次出现该房源。任何变动都会显示在此。", ta: "இதுவரை விலை மாற்றம் எதுவும் இல்லை — இந்த பட்டியலை முதல் வாரம் பார்க்கிறோம். மாற்றம் இங்கே தெரியும்.", gu: "હજી કિંમતમાં ફેરફાર નથી — આ યાદી પહેલી વાર દેખાઈ છે. કોઈપણ ફેરફાર અહીં દેખાશે.", pa: "ਹਾਲੇ ਕੀਮਤ ਵਿੱਚ ਕੋਈ ਬਦਲਾਅ ਨਹੀਂ — ਇਹ ਲਿਸਟਿੰਗ ਪਹਿਲੀ ਵਾਰ ਦਿਖੀ ਹੈ। ਬਦਲਾਅ ਇੱਥੇ ਦਿਖੇਗਾ।", hi: "अभी कोई मूल्य परिवर्तन नहीं — यह लिस्टिंग पहली बार दिखी है। कोई भी बदलाव यहाँ दिखेगा।" },
  ...
  "prop.matchedPool": { en: "Matched to sales with the same pool status ({pool}). ", zh: "已匹配相同泳池情况的成交（{pool}）。", ta: "அதே நீச்சல் குள நிலையுடன் ({pool}) விற்பனைகளுடன் பொருத்தப்பட்டது. ", gu: "સમાન સ્વિમિંગ પૂલ સ્થિતિ ({pool}) વાળા વેચાણ સાથે મેળ કર્યો. ", pa: "ਉਸੇ ਸਵਿਮਿੰਗ ਪੂਲ ਸਥਿਤੀ ({pool}) ਵਾਲੀਆਂ ਵਿਕਰੀਆਂ ਨਾਲ ਮੇਲ ਕੀਤਾ। ", hi: "समान स्विमिंग पूल स्थिति ({pool}) वाली बिक्री से मेल किया गया। " },
  "prop.mixedPool": { en: "Too few sales here match this property on a pool, so both are shown and the difference is allowed for. ", zh: "此处泳池情况匹配的成交太少，故同时显示两者并已计入差异。", ta: "நீச்சல் குளத்தில் பொருந்தும் விற்பனைகள் மிகக் குறைவு, எனவே இரண்டும் காட்டப்பட்டு வேறுபாடு கணக்கில் எடுக்கப்படுகிறது. ", gu: "પૂલ પર મેળ ખાતી વેચાણ બહુ ઓછી છે, તેથી બંને બતાવાય છે અને તફાવત ગણતરીમાં લેવાયો છે. ", pa: "ਪੂਲ ਦੇ ਹਿਸਾਬ ਨਾਲ ਮੇਲ ਖਾਂਦੀਆਂ ਵਿਕਰੀਆਂ ਬਹੁਤ ਘੱਟ ਹਨ, ਇਸ ਲਈ ਦੋਵੇਂ ਦਿਖਾਏ ਗਏ ਹਨ ਅਤੇ ਫ਼ਰਕ ਦਾ ਹਿਸਾਬ ਰੱਖਿਆ ਗਿਆ ਹੈ। ", hi: "पूल के हिसाब से मेल खाती बिक्री बहुत कम हैं, इसलिए दोनों दिखाई गई हैं और अंतर का हिसाब रखा गया है। " },
  ...
  "today.historyThin": { en: "No trend for this region yet.", zh: "该地区暂无趋势。", ta: "இந்தப் பகுதிக்கு இன்னும் போக்கு இல்லை.", gu: "આ પ્રદેશ માટે હજી વલણ નથી.", pa: "ਇਸ ਖੇਤਰ ਲਈ ਹਾਲੇ ਕੋਈ ਰੁਝਾਨ ਨਹੀਂ।", hi: "इस क्षेत्र के लिए अभी कोई रुझान नहीं।" },
  "today.medianSold": { en: "Median sale price", zh: "成交价中位数", ta: "இடைநிலை விற்பனை விலை", gu: "મધ્યક વેચાણ કિંમત", pa: "ਮੱਧਮਾਨ ਵਿਕਰੀ ਮੁੱਲ", hi: "मध्यक बिक्री मूल्य" },
  "today.salesPerMonth": { en: "Sales a month", zh: "每月成交量", ta: "மாதத்திற்கு விற்பனைகள்", gu: "મહિનાના વેચાણ", pa: "ਪ੍ਰਤੀ ਮਹੀਨਾ ਵਿਕਰੀਆਂ", hi: "प्रति माह बिक्री" },
  "today.sinceWhen": { en: "since {when}", zh: "自 {when} 以来", ta: "{when} முதல்", gu: "{when} થી", pa: "{when} ਤੋਂ", hi: "{when} से" },
  "today.sinceFirst": { en: "since we started tracking", zh: "自开始跟踪以来", ta: "கண்காணிக்கத் தொடங்கியதிலிருந்து", gu: "ટ્રેકિંગ શરૂ કર્યા પછી", pa: "ਟਰੈਕਿੰਗ ਸ਼ੁਰੂ ਹੋਣ ਤੋਂ", hi: "ट्रैकिंग शुरू होने के बाद से" },
  "today.ourEstimate": { en: "Our estimate", zh: "我们的估值", ta: "எங்கள் மதிப்பீடு", gu: "અમારો અંદાજ", pa: "ਸਾਡਾ ਅੰਦਾਜ਼ਾ", hi: "हमारा अनुमान" },
  "today.medianDom": { en: "Median estimated days to sell", zh: "预计售期中位数", ta: "இடைநிலை மதிப்பிடப்பட்ட விற்பனை நாட்கள்", gu: "મધ્યક અંદાજિત વેચાણ દિવસ", pa: "ਮੱਧਮਾਨ ਅਨੁਮਾਨਿਤ ਵਿਕਰੀ ਦਿਨ", hi: "मध्यक अनुमानित बिक्री दिन" },
  ...
  "today.snapshotRhythm": { en: "Market coverage", zh: "市场覆盖", ta: "சந்தை பரப்பு", gu: "બજાર કવરેજ", pa: "ਬਾਜ਼ਾਰ ਕਵਰੇਜ", hi: "बाज़ार कवरेज" },
  "today.weekly": { en: "Weekly", zh: "每周", ta: "வாராந்திரம்", gu: "સાપ્તાહિક", pa: "ਹਫ਼ਤਾਵਾਰ", hi: "साप्ताहिक" },
  "today.snapshotSub": { en: "{n} live listings, priced", zh: "{n} 条在售，已估价", ta: "{n} நேரடி பட்டியல்கள், விலை மதிப்பிடப்பட்டது", gu: "{n} લાઇવ યાદીઓ, કિંમત આંકેલી", pa: "{n} ਲਾਈਵ ਲਿਸਟਿੰਗਾਂ, ਕੀਮਤ ਲਗਾਈ", hi: "{n} लाइव लिस्टिंग, मूल्यांकित" },
  ...
  "today.comparingSnapshots": { en: "comparing the last two weeks", zh: "对比最近两周", ta: "கடந்த இரண்டு வாரங்களை ஒப்பிடுகிறது", gu: "છેલ્લા બે અઠવાડિયાની સરખામણી", pa: "ਪਿਛਲੇ ਦੋ ਹਫ਼ਤਿਆਂ ਦੀ ਤੁਲਨਾ", hi: "पिछले दो सप्ताह की तुलना" },
  ...
  "hd.estimateNote": { en: "Value gaps compare estimated value with asking price; they are not profit. Subdivision figures use modelled costs and assume feasibility. Open a property to inspect the evidence and assumptions.", zh: "价差比较估值与要价，并不等于利润。分割数据采用模型成本并假定方案可行。请打开房源查看证据和假设。" },
  "hd.marginGems": { en: "ESTIMATED VALUE GAP · 8+ COMPARABLES", zh: "估值差额 · 至少8条可比成交", ta: "உயர்-நம்பிக்கை டீல்களில் வித்தியாசம்", gu: "ઊંચા-વિશ્વાસ ડીલ પર તફાવત", pa: "ਉੱਚ-ਭਰੋਸਾ ਡੀਲਾਂ 'ਤੇ ਅੰਤਰ", hi: "उच्च-विश्वास डील पर अंतर" },
  "hd.subdivProfit": { en: "ESTIMATED SUBDIVISION NET GAIN", zh: "分割净收益估算", ta: "கிடைக்கும் உட்பிரிவு லாபம்", gu: "ઉપલબ્ધ ઉપવિભાજન લાભ", pa: "ਉਪਲਬਧ ਉਪਵੰਡ ਲਾਭ", hi: "उपलब्ध उपविभाजन लाभ" },
  "hd.bedroomUplift": { en: "MODELLED BEDROOM VALUE UPLIFT", zh: "模型估算的卧室增值", ta: "படுக்கையறை சேர்ப்பதால் மதிப்பு உயர்வு", gu: "બેડરૂમ ઉમેરવાથી મૂલ્ય વધારો", pa: "ਬੈੱਡਰੂਮ ਜੋੜਨ ਨਾਲ ਮੁੱਲ ਵਾਧਾ", hi: "बेडरूम जोड़ने से मूल्य वृद्धि" },
  "hd.marginAll": { en: "ESTIMATED GAP ACROSS UNDERPRICED LISTINGS", zh: "低估房源的估值差额合计", ta: "அனைத்து குறைந்த விலையிலும் மொத்த வித்தியாசம்", gu: "બધી ઓછી કિંમત પર કુલ તફાવત", pa: "ਸਾਰੀਆਂ ਘੱਟ ਕੀਮਤ 'ਤੇ ਕੁੱਲ ਅੰਤਰ", hi: "सभी कम कीमत पर कुल अंतर" },
  "hd.gemsHint": { en: "across {n} listings · 15%+ uplift over asking, 8+ comps", zh: "覆盖 {n} 条 · 相对要价的估值增幅至少15%，至少8条可比成交", ta: "{n} பட்டியல்களில் · கேட்கும் விலையை விட மதிப்பீடு 15%+ அதிகம், 8+ ஒப்பிடத்தக்க விற்பனைகள்", gu: "{n} લિસ્ટિંગમાં · માગેલી કિંમત કરતાં અંદાજિત મૂલ્ય 15%+ વધુ, 8+ તુલનાત્મક વેચાણ", pa: "{n} ਲਿਸਟਿੰਗਾਂ ਵਿੱਚ · ਮੰਗੀ ਕੀਮਤ ਤੋਂ ਅਨੁਮਾਨਿਤ ਮੁੱਲ 15%+ ਵੱਧ, 8+ ਤੁਲਨਾਯੋਗ ਵਿਕਰੀਆਂ", hi: "{n} लिस्टिंग में · माँगी गई कीमत से अनुमानित मूल्य 15%+ अधिक, 8+ तुलनीय बिक्री" },
  "hd.subdivHint": { en: "{n} potential sites · total includes modelled profitable strategies only", zh: "{n} 处潜在地块 · 合计仅包含模型估算盈利的方案", ta: "{n} மனைகளில் · அனுமதி மற்றும் நிதிக்கு முன்", gu: "{n} પ્લોટ પર · મંજૂરી અને નાણાં પહેલા", pa: "{n} ਪਲਾਟਾਂ 'ਤੇ · ਮਨਜ਼ੂਰੀ ਅਤੇ ਵਿੱਤ ਤੋਂ ਪਹਿਲਾਂ", hi: "{n} प्लॉट पर · अनुमति और वित्त से पहले" },
  "hd.bedroomHint": { en: "{n} houses pass the floor-area screen · {dp} also underpriced; layout and costs need checking", zh: "{n} 套通过面积筛选 · {dp} 套同时低估；布局和成本仍需核实", ta: "{n} வீடுகளில் ஏற்கனவே தள பரப்பு உள்ளது · {dp} குறைந்த விலையும்", gu: "{n} ઘરો પાસે પહેલેથી ફ્લોર ક્ષેત્ર છે · {dp} ઓછી કિંમત પણ", pa: "{n} ਘਰਾਂ ਕੋਲ ਪਹਿਲਾਂ ਹੀ ਫ਼ਲੋਰ ਖੇਤਰ ਹੈ · {dp} ਘੱਟ ਕੀਮਤ ਵੀ", hi: "{n} घरों में पहले से फ़्लोर क्षेत्र है · {dp} कम कीमत भी" },
  "hd.marginHint": { en: "across {n} listings · same quality filters as Underpriced", zh: "覆盖 {n} 条 · 与低估房源页面使用相同质量筛选", ta: "{n} பட்டியல்களில் · குறைந்த விலை வீடுகள் பக்கத்தில் உள்ள அதே தர வடிகட்டிகள்", gu: "{n} લિસ્ટિંગમાં · ઓછી કિંમતનાં ઘરોના પૃષ્ઠ જેવા જ ગુણવત્તા ફિલ્ટર", pa: "{n} ਲਿਸਟਿੰਗਾਂ ਵਿੱਚ · ਘੱਟ ਕੀਮਤ ਵਾਲੇ ਘਰਾਂ ਦੇ ਪੰਨੇ ਵਾਲੇ ਹੀ ਗੁਣਵੱਤਾ ਫਿਲਟਰ", hi: "{n} लिस्टिंग में · कम कीमत वाले घरों के पृष्ठ जैसे ही गुणवत्ता फ़िल्टर" },
  "hd.biggestGap": { en: "◆ LARGEST ESTIMATED GAP IN SCREENED LISTINGS", zh: "◆ 已筛选房源中的最大估值差额", ta: "◆ இப்போது சந்தையில் மிகப்பெரிய வித்தியாசம்", gu: "◆ અત્યારે બજારમાં સૌથી મોટો તફાવત", pa: "◆ ਹੁਣ ਬਾਜ਼ਾਰ ਵਿੱਚ ਸਭ ਤੋਂ ਵੱਡਾ ਅੰਤਰ", hi: "◆ अभी बाज़ार में सबसे बड़ा अंतर" },
  ...
  "hd.margin": { en: "{pct} value uplift over asking", zh: "相对要价的估值增幅 {pct}", ta: "{pct} வித்தியாசம்", gu: "{pct} તફાવત", pa: "{pct} ਅੰਤਰ", hi: "{pct} अंतर" },

  // --- value-add districts (today) ---
  "vad.title": { en: "Sale-price differences by feature and district", zh: "各区域不同特征的成交价差异", ta: "மாவட்டப்படி புதுப்பித்தல் சேர்க்கும் மதிப்பு", gu: "જિલ્લા પ્રમાણે નવીનીકરણથી મૂલ્ય વધારો", pa: "ਜ਼ਿਲ੍ਹੇ ਅਨੁਸਾਰ ਨਵੀਨੀਕਰਨ ਨਾਲ ਮੁੱਲ ਵਾਧਾ", hi: "ज़िले के अनुसार नवीनीकरण से मूल्य वृद्धि" },
  "vad.sub": { en: "Matched sold-house comparisons control for size, property type and the other room count. They show observed price differences, not guaranteed renovation returns.", zh: "匹配成交对比控制面积、房型及另一种房间数量。显示的是观察到的价格差异，并非保证的装修回报。", ta: "விற்கப்பட்ட வீடுகளின் பொருத்தப்பட்ட ஒப்பீடுகளில் அளவு, சொத்து வகை மற்றும் மற்ற அறை வகையின் எண்ணிக்கை கட்டுப்படுத்தப்படுகின்றன. இவை காணப்பட்ட விலை வேறுபாடுகள்; புதுப்பித்தலின் உறுதியான வருமானம் அல்ல.", gu: "વેચાયેલાં ઘરોની મેળ-આધારિત તુલનામાં કદ, મિલકતનો પ્રકાર અને બીજા પ્રકારના રૂમની સંખ્યાને નિયંત્રિત કરવામાં આવે છે. આ જોવા મળેલા કિંમતના તફાવતો છે, નવીનીકરણનું ખાતરીવાળું વળતર નહીં.", pa: "ਵਿਕੇ ਘਰਾਂ ਦੀ ਮੇਲ-ਅਧਾਰਿਤ ਤੁਲਨਾ ਵਿੱਚ ਆਕਾਰ, ਜਾਇਦਾਦ ਦੀ ਕਿਸਮ ਅਤੇ ਦੂਜੀ ਕਿਸਮ ਦੇ ਕਮਰਿਆਂ ਦੀ ਗਿਣਤੀ ਨੂੰ ਕੰਟਰੋਲ ਕੀਤਾ ਜਾਂਦਾ ਹੈ। ਇਹ ਵੇਖੇ ਗਏ ਕੀਮਤ ਅੰਤਰ ਹਨ, ਮੁਰੰਮਤ ਦੇ ਪੱਕੇ ਲਾਭ ਨਹੀਂ।", hi: "बिके घरों की मिलान-आधारित तुलना में आकार, संपत्ति का प्रकार और दूसरे प्रकार के कमरों की संख्या को नियंत्रित किया जाता है। यह देखे गए मूल्य अंतर दिखाती है, नवीनीकरण के निश्चित प्रतिफल नहीं।" },
  ...
  "vad.note": { en: "The small grey number shows matched comparison groups; a dash means insufficient evidence. These are differences between sold homes, not before-and-after renovation results. Condition, finish and other unmeasured features may affect prices. Pool figures are associations, not the value added by installing a pool. Check costs and property-specific feasibility before using any uplift.", zh: "小号灰色数字表示匹配对比组数；破折号表示证据不足。这些是不同已售房屋之间的差异，并非装修前后的结果。房况、装修质量及其他未测量因素也可能影响价格。泳池数据表示相关性，而非安装泳池所带来的增值。使用任何增值估算前，请核实成本及具体房屋的可行性。", ta: "சிறிய சாம்பல் நிற எண் பொருத்தப்பட்ட ஒப்பீட்டுக் குழுக்களின் எண்ணிக்கையைக் காட்டுகிறது; கோடு போதிய ஆதாரம் இல்லை என்பதைக் குறிக்கிறது. இவை விற்கப்பட்ட வீடுகளுக்கு இடையிலான வேறுபாடுகள்; புதுப்பித்தலுக்கு முன் மற்றும் பின் கிடைத்த முடிவுகள் அல்ல. வீட்டின் நிலை, வேலைப்பாட்டுத் தரம் மற்றும் அளவிடப்படாத பிற அம்சங்கள் விலையைப் பாதிக்கலாம். நீச்சல் குளத் தரவுகள் தொடர்பைக் காட்டுகின்றன; குளம் அமைப்பதால் சேரும் மதிப்பைக் காட்டுவதில்லை. எந்த மதிப்பு உயர்வு மதிப்பீட்டையும் பயன்படுத்தும் முன் செலவுகளையும் அந்தச் சொத்தின் சாத்தியக்கூறுகளையும் சரிபார்க்கவும்.", gu: "નાનો ભૂખરો આંકડો મેળ ખાતા તુલના જૂથોની સંખ્યા છે; ડૅશનો અર્થ પૂરતા પુરાવા નથી. આ વેચાયેલાં ઘરો વચ્ચેના તફાવતો છે, નવીનીકરણ પહેલાં અને પછીનાં પરિણામો નહીં. ઘરની સ્થિતિ, ફિનિશ અને અન્ય ન માપેલી વિશેષતાઓ કિંમતોને અસર કરી શકે છે. પૂલના આંકડા સંબંધ દર્શાવે છે, પૂલ બનાવવાથી ઉમેરાતું મૂલ્ય નહીં. કોઈપણ મૂલ્યવૃદ્ધિના અંદાજનો ઉપયોગ કરતાં પહેલાં ખર્ચ અને તે મિલકતની વ્યવહાર્યતા તપાસો.", pa: "ਛੋਟਾ ਸਲੇਟੀ ਅੰਕ ਮੇਲ ਖਾਂਦੇ ਤੁਲਨਾ ਸਮੂਹਾਂ ਦੀ ਗਿਣਤੀ ਹੈ; ਡੈਸ਼ ਦਾ ਮਤਲਬ ਸਬੂਤ ਘੱਟ ਹਨ। ਇਹ ਵਿਕੇ ਘਰਾਂ ਵਿਚਕਾਰ ਅੰਤਰ ਹਨ, ਮੁਰੰਮਤ ਤੋਂ ਪਹਿਲਾਂ ਅਤੇ ਬਾਅਦ ਦੇ ਨਤੀਜੇ ਨਹੀਂ। ਘਰ ਦੀ ਹਾਲਤ, ਫਿਨਿਸ਼ ਅਤੇ ਹੋਰ ਨਾ ਮਾਪੀਆਂ ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ ਕੀਮਤਾਂ ਨੂੰ ਪ੍ਰਭਾਵਿਤ ਕਰ ਸਕਦੀਆਂ ਹਨ। ਪੂਲ ਦੇ ਅੰਕੜੇ ਸੰਬੰਧ ਦਿਖਾਉਂਦੇ ਹਨ, ਪੂਲ ਬਣਾਉਣ ਨਾਲ ਜੁੜਿਆ ਮੁੱਲ ਨਹੀਂ। ਕਿਸੇ ਵੀ ਮੁੱਲ-ਵਾਧੇ ਦੇ ਅਨੁਮਾਨ ਨੂੰ ਵਰਤਣ ਤੋਂ ਪਹਿਲਾਂ ਲਾਗਤਾਂ ਅਤੇ ਉਸ ਜਾਇਦਾਦ ਦੀ ਵਿਹਾਰਕ ਸੰਭਾਵਨਾ ਜਾਂਚੋ।", hi: "छोटी धूसर संख्या मिलान किए गए तुलना समूहों की संख्या है; डैश का अर्थ अपर्याप्त साक्ष्य है। ये बिके घरों के बीच के अंतर हैं, नवीनीकरण से पहले और बाद के परिणाम नहीं। घर की स्थिति, फिनिश और अन्य अनमापी विशेषताएँ कीमतों को प्रभावित कर सकती हैं। पूल के आँकड़े सहसंबंध दिखाते हैं, पूल लगाने से जुड़ने वाला मूल्य नहीं। किसी भी मूल्य-वृद्धि अनुमान का उपयोग करने से पहले लागत और उस संपत्ति की व्यवहार्यता जाँचें।" },
  ...
  "trends.introB": { en: "week-by-week asking prices", zh: "逐周报价", ta: "வாரந்தோறும் கேட்கும் விலைகள்", gu: "અઠવાડિક માંગ કિંમતો", pa: "ਹਫ਼ਤਾਵਾਰੀ ਮੰਗ ਕੀਮਤਾਂ", hi: "साप्ताहिक मांग कीमतें" },
  "trends.intro": { en: "Two views of how a suburb has moved: {a}, plus {b} over a shorter horizon.", zh: "两种查看区域走势的方式：{a}，以及较短周期的 {b}。", ta: "ஒரு புறநகர் எப்படி நகர்ந்தது என்பதற்கு இரண்டு பார்வைகள்: {a}, மற்றும் குறுகிய காலத்தில் {b}.", gu: "ઉપનગર કેવી રીતે બદલાયું તેના બે દૃશ્યો: {a}, અને ટૂંકા ગાળામાં {b}.", pa: "ਉਪਨਗਰ ਕਿਵੇਂ ਬਦਲਿਆ, ਦੋ ਨਜ਼ਰੀਏ: {a}, ਅਤੇ ਛੋਟੇ ਸਮੇਂ ਵਿੱਚ {b}।", hi: "उपनगर कैसे बदला, दो दृश्य: {a}, और छोटी अवधि में {b}।" },
  "trends.allTypes": { en: "All types", zh: "所有类型", ta: "அனைத்து வகைகளும்", gu: "બધા પ્રકારો", pa: "ਸਾਰੀਆਂ ਕਿਸਮਾਂ", hi: "सभी प्रकार" },
  ...
  "trends.snapshotsSoFar": { en: "Weeks tracked", zh: "已跟踪周数", ta: "கண்காணித்த வாரங்கள்", gu: "ટ્રેક કરેલા અઠવાડિયા", pa: "ਟਰੈਕ ਕੀਤੇ ਹਫ਼ਤੇ", hi: "ट्रैक किए गए सप्ताह" },
  ...
  "trends.weeklySnapshots": { en: "Asking prices, week by week", zh: "每周报价", ta: "வாரந்தோறும் கேட்கும் விலைகள்", gu: "અઠવાડિક માંગ કિંમતો", pa: "ਹਫ਼ਤਾਵਾਰੀ ਮੰਗ ਕੀਮਤਾਂ", hi: "साप्ताहिक मांग कीमतें" },
  "trends.medianAcross": { en: "Median across listings active in {suburb} each week", zh: "{suburb} 每周在售房源的中位数", ta: "ஒவ்வொரு வாரமும் {suburb} இல் உள்ள பட்டியல்களின் இடைநிலை", gu: "દર અઠવાડિયે {suburb} માં સક્રિય યાદીઓનો મધ્યક", pa: "ਹਰ ਹਫ਼ਤੇ {suburb} ਵਿੱਚ ਸਰਗਰਮ ਲਿਸਟਿੰਗਾਂ ਦਾ ਮੱਧਮਾਨ", hi: "हर सप्ताह {suburb} में सक्रिय लिस्टिंग का मध्यक" },
  "trends.snapshot": { en: "Week", zh: "周", ta: "வாரம்", gu: "અઠવાડિયું", pa: "ਹਫ਼ਤਾ", hi: "सप्ताह" },
  "trends.snapshotN": { en: "{n} week", zh: "{n} 周", ta: "{n} வாரம்", gu: "{n} અઠવાડિયું", pa: "{n} ਹਫ਼ਤਾ", hi: "{n} सप्ताह" },
  "trends.snapshotNPlural": { en: "{n} weeks", zh: "{n} 周", ta: "{n} வாரங்கள்", gu: "{n} અઠવાડિયા", pa: "{n} ਹਫ਼ਤੇ", hi: "{n} सप्ताह" },
  ...
  "trends.onlyOne": { en: "Only one week so far. Next week you will see how the median has moved.", zh: "目前仅一周数据。下周即可看到中位数的变化。", ta: "இதுவரை ஒரு வாரம் மட்டுமே. அடுத்த வாரம் இடைநிலை எப்படி நகர்ந்தது தெரியும்.", gu: "હજી માત્ર એક અઠવાડિયું. આવતા અઠવાડિયે મધ્યક કેવી રીતે બદલાયો તે દેખાશે.", pa: "ਹੁਣ ਤੱਕ ਸਿਰਫ਼ ਇੱਕ ਹਫ਼ਤਾ। ਅਗਲੇ ਹਫ਼ਤੇ ਮੱਧਮਾਨ ਦੀ ਤਬਦੀਲੀ ਦਿਖੇਗੀ।", hi: "अभी केवल एक सप्ताह। अगले सप्ताह मध्यक की चाल दिखेगी।" },
  ...
  "ptable.buyPrice": { en: "Est. buy price", zh: "预估买入价", ta: "மதிப்பிட்ட வாங்கும் விலை", gu: "અંદાજિત ખરીદ ભાવ", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ", hi: "अनुमानित खरीद मूल्य" },
  ...
  "ask.placeholderKeyUnreadable": { en: "Ollie's key needs re-entering by an admin…", zh: "需要管理员重新输入 Ollie 的密钥…", hi: "व्यवस्थापक को Ollie की कुंजी फिर से डालनी होगी…", pa: "ਐਡਮਿਨ ਨੂੰ Ollie ਦੀ ਕੁੰਜੀ ਦੁਬਾਰਾ ਭਰਨੀ ਪਵੇਗੀ…", gu: "એડમિને Ollie ની કી ફરીથી દાખલ કરવી પડશે…", ta: "நிர்வாகி Ollie இன் விசையை மீண்டும் உள்ளிட வேண்டும்…" },
  "ask.keyUnreadable": { en: "Ollie's key is saved but can't be read — this happens after a server key change. An administrator needs to re-enter it in the admin panel. Nothing to do at your end.", zh: "Ollie 的密钥已保存但无法读取——这在服务器密钥更改后会发生。需要管理员在管理面板中重新输入。您无需操作。", hi: "Ollie की कुंजी सहेजी गई है पर पढ़ी नहीं जा सकती — सर्वर कुंजी बदलने के बाद ऐसा होता है। व्यवस्थापक को इसे फिर से डालना होगा। आपको कुछ नहीं करना है।", pa: "Ollie ਦੀ ਕੁੰਜੀ ਸੰਭਾਲੀ ਹੈ ਪਰ ਪੜ੍ਹੀ ਨਹੀਂ ਜਾ ਸਕਦੀ — ਸਰਵਰ ਕੁੰਜੀ ਬਦਲਣ ਤੋਂ ਬਾਅਦ ਅਜਿਹਾ ਹੁੰਦਾ ਹੈ। ਐਡਮਿਨ ਨੂੰ ਦੁਬਾਰਾ ਭਰਨੀ ਪਵੇਗੀ।", gu: "Ollie ની કી સાચવેલી છે પણ વાંચી શકાતી નથી — સર્વર કી બદલ્યા પછી આવું થાય છે. એડમિને ફરીથી દાખલ કરવી પડશે.", ta: "Ollie இன் விசை சேமிக்கப்பட்டுள்ளது ஆனால் படிக்க முடியவில்லை — சேவையக விசை மாற்றத்திற்குப் பிறகு இது நிகழும். நிர்வாகி மீண்டும் உள்ளிட வேண்டும்." },
  "ask.keyMissing": { en: "Ollie needs an API key before he can answer anything.", zh: "Ollie 需要 API 密钥才能回答。", hi: "उत्तर देने के लिए Ollie को एक API कुंजी चाहिए।", pa: "ਜਵਾਬ ਦੇਣ ਲਈ Ollie ਨੂੰ API ਕੁੰਜੀ ਚਾਹੀਦੀ ਹੈ।", gu: "જવાબ આપવા માટે Ollie ને API કી જોઈએ.", ta: "பதிலளிக்க Ollie க்கு ஒரு API விசை தேவை." },
  "subcalc.altKeeping": { en: "Keeping the house instead:", zh: "改为保留房屋：", hi: "इसके बजाय घर रखना:", pa: "ਇਸ ਦੀ ਬਜਾਏ ਘਰ ਰੱਖਣਾ:", gu: "તેના બદલે ઘર રાખવું:", ta: "மாறாக வீட்டை வைத்திருப்பது:" },
  "subcalc.altDemolishing": { en: "Demolishing instead:", zh: "改为拆除：", hi: "इसके बजाय गिराना:", pa: "ਇਸ ਦੀ ਬਜਾਏ ਢਾਹੁਣਾ:", gu: "તેના બદલે તોડવું:", ta: "மாறாக இடிப்பது:" },
  "subcalc.altBy": { en: "{amount} behind", zh: "少 {amount}", hi: "{amount} कम", pa: "{amount} ਘੱਟ", gu: "{amount} ઓછું", ta: "{amount} குறைவு" },
  ...
  "subcalc.noEstimateTitle": { en: "We can't price a subdivision here.", zh: "我们无法为此处的分割给出估价。", ta: "இங்கு உட்பிரிவுக்கு விலை நிர்ணயிக்க முடியாது.", gu: "અમે અહીં ઉપવિભાજનની કિંમત આંકી શકતા નથી.", pa: "ਅਸੀਂ ਇੱਥੇ ਉਪਵੰਡ ਦੀ ਕੀਮਤ ਨਹੀਂ ਲਗਾ ਸਕਦੇ।", hi: "हम यहाँ उपविभाजन की कीमत नहीं आँक सकते।" },
  "subcalc.noEstimateBody": { en: "The section rate for this land doesn't hold up against what the whole site is selling for, so any profit figure we produced would be misleading. We'd rather show nothing than a number we can't stand behind. Worth checking manually with the council if the site interests you.", zh: "该地块的分割地价与整体售价不符，因此任何利润数字都会产生误导。与其给出无法支撑的数字，我们选择不显示。若你对该地块有兴趣，建议向议会人工核实。", ta: "இந்த நிலத்தின் மனை விகிதம் முழு இடத்தின் விற்பனை விலையுடன் பொருந்தவில்லை, எனவே எந்த லாப எண்ணும் தவறாக வழிநடத்தும். நிற்க முடியாத எண்ணைக் காட்டுவதை விட எதுவும் காட்டாமல் இருப்பதே சிறந்தது. ஆர்வம் இருந்தால் கவுன்சிலிடம் கைமுறையாக சரிபார்க்கவும்.", gu: "આ જમીનનો સેક્શન દર આખી સાઇટની વેચાણ કિંમત સામે ટકતો નથી, તેથી કોઈપણ નફાનો આંકડો ભ્રામક હશે. જે આંકડા પાછળ ઊભા ન રહી શકીએ તે બતાવવા કરતાં કંઈ ન બતાવવું સારું. રસ હોય તો કાઉન્સિલ સાથે જાતે ચકાસો.", pa: "ਇਸ ਜ਼ਮੀਨ ਦੀ ਸੈਕਸ਼ਨ ਦਰ ਪੂਰੀ ਸਾਈਟ ਦੀ ਵਿਕਰੀ ਕੀਮਤ ਨਾਲ ਮੇਲ ਨਹੀਂ ਖਾਂਦੀ, ਇਸ ਲਈ ਕੋਈ ਵੀ ਮੁਨਾਫ਼ਾ ਅੰਕੜਾ ਗੁੰਮਰਾਹਕੁੰਨ ਹੋਵੇਗਾ। ਜਿਸ ਅੰਕੜੇ ਪਿੱਛੇ ਖੜ੍ਹ ਨਾ ਸਕੀਏ, ਉਸ ਨਾਲੋਂ ਕੁਝ ਨਾ ਦਿਖਾਉਣਾ ਬਿਹਤਰ ਹੈ। ਦਿਲਚਸਪੀ ਹੋਵੇ ਤਾਂ ਕੌਂਸਲ ਤੋਂ ਖੁਦ ਜਾਂਚੋ।", hi: "इस ज़मीन की सेक्शन दर पूरी साइट की बिक्री कीमत के सामने टिकती नहीं, इसलिए कोई भी लाभ आँकड़ा भ्रामक होगा। जिस आँकड़े के पीछे खड़े न हो सकें, उससे बेहतर है कुछ न दिखाना। रुचि हो तो काउंसिल से स्वयं जाँचें।" },
  ...
  "subcalc.lotsSaving": { en: "Saving\u2026", zh: "保存中…", ta: "சேமிக்கிறது…", gu: "સાચવી રહ્યું છે…", pa: "ਸੰਭਾਲ ਰਿਹਾ ਹੈ…", hi: "सहेजा जा रहा है…" },
  "subcalc.lotsSaved": { en: "Saved \u2014 this is what goes live.", zh: "已保存 — 上线后即为此值。", ta: "சேமிக்கப்பட்டது \u2014 இதுவே நேரலைக்குச் செல்லும்.", gu: "સાચવ્યું \u2014 આ જ લાઇવ થશે.", pa: "ਸੰਭਾਲਿਆ \u2014 ਇਹੀ ਲਾਈਵ ਜਾਵੇਗਾ।", hi: "सहेजा गया \u2014 यही लाइव होगा।" },
  "subcalc.lotsSaveFailed": { en: "Not saved \u2014 try again.", zh: "未保存 — 请重试。", ta: "சேமிக்கப்படவில்லை \u2014 மீண்டும் முயற்சிக்கவும்.", gu: "સાચવ્યું નથી \u2014 ફરી પ્રયાસ કરો.", pa: "ਸੰਭਾਲਿਆ ਨਹੀਂ \u2014 ਮੁੜ ਕੋਸ਼ਿਸ਼ ਕਰੋ।", hi: "सहेजा नहीं गया \u2014 पुनः प्रयास करें।" },
  "subcalc.lotsHint": { en: "Change this if the site takes more", zh: "如果地块可分更多，请修改", ta: "தளம் அதிகம் எடுத்தால் இதை மாற்றவும்", gu: "સાઇટ વધુ લે તો આ બદલો", pa: "ਜੇ ਸਾਈਟ ਵੱਧ ਲੈਂਦੀ ਹੈ ਤਾਂ ਬਦਲੋ", hi: "यदि साइट अधिक लेती है तो बदलें" },
  "subcalc.lotsEdited": { en: "Your number, not the model's.", zh: "这是你填的数字，非模型值。", ta: "உங்கள் எண், மாதிரியின் அல்ல.", gu: "તમારો આંકડો, મોડેલનો નહીં.", pa: "ਤੁਹਾਡਾ ਅੰਕੜਾ, ਮਾਡਲ ਦਾ ਨਹੀਂ।", hi: "आपकी संख्या, मॉडल की नहीं।" },
  "subcalc.lotsReset": { en: "Use the model's", zh: "使用模型值", ta: "மாதிரியின் எண்ணைப் பயன்படுத்து", gu: "મોડેલનો ઉપયોગ કરો", pa: "ਮਾਡਲ ਦਾ ਵਰਤੋ", hi: "मॉडल का उपयोग करें" },
  "subcalc.lotsMore": { en: "One more lot", zh: "增加一块", ta: "இன்னும் ஒரு மனை", gu: "એક વધુ પ્લોટ", pa: "ਇੱਕ ਹੋਰ ਪਲਾਟ", hi: "एक और लॉट" },
  "subcalc.lotsFewer": { en: "One fewer lot", zh: "减少一块", ta: "ஒரு மனை குறைவாக", gu: "એક ઓછો પ્લોટ", pa: "ਇੱਕ ਘੱਟ ਪਲਾਟ", hi: "एक कम लॉट" },
  "subcalc.buyPrice": { en: "Est. buy price", zh: "预估买入价", ta: "மதிப்பிட்ட வாங்கும் விலை", gu: "અંદાજિત ખરીદ ભાવ", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ", hi: "अनुमानित खरीद मूल्य" },
  ...
  "strend.soFarTo": { en: "{year} so far — {n} sales to {month}.", zh: "{year} 年至今 — 截至 {month} 共 {n} 宗成交。", ta: "{year} இதுவரை — {month} வரை {n} விற்பனைகள்.", gu: "{year} અત્યાર સુધી — {month} સુધી {n} વેચાણ.", pa: "{year} ਹੁਣ ਤੱਕ — {month} ਤੱਕ {n} ਵਿਕਰੀਆਂ।", hi: "{year} अब तक — {month} तक {n} बिक्री।" },
  "strend.soFarPlain": { en: "{year} so far — {n} sales.", zh: "{year} 年至今 — 共 {n} 宗成交。", ta: "{year} இதுவரை — {n} விற்பனைகள்.", gu: "{year} અત્યાર સુધી — {n} વેચાણ.", pa: "{year} ਹੁਣ ਤੱਕ — {n} ਵਿਕਰੀਆਂ।", hi: "{year} अब तक — {n} बिक्री।" },
  "strend.vsYear": { en: "on {year}", zh: "对比 {year}", ta: "{year} உடன்", gu: "{year} સામે", pa: "{year} ਦੇ ਮੁਕਾਬਲੇ", hi: "{year} की तुलना में" },
  "strend.through": { en: "so far, to {month}", zh: "截至 {month}", ta: "{month} வரை", gu: "{month} સુધી", pa: "{month} ਤੱਕ", hi: "{month} तक" },
  "strend.soFar": { en: "year so far", zh: "本年至今", ta: "இந்த ஆண்டு இதுவரை", gu: "આ વર્ષ અત્યાર સુધી", pa: "ਇਸ ਸਾਲ ਹੁਣ ਤੱਕ", hi: "इस वर्ष अब तक" },
  "strend.ytdNote": { en: "The dashed step is {year} so far — {n} sales to {month}. It is where the market is now, not a finished year.", zh: "虚线段为 {year} 年至今——截至 {month} 共 {n} 宗成交。它反映当前市场，而非完整年度。", ta: "புள்ளியிட்ட படி {year} இதுவரை — {month} வரை {n} விற்பனைகள். இது இப்போதைய சந்தை, முடிந்த ஆண்டு அல்ல.", gu: "ડૅશવાળું પગથિયું {year} અત્યાર સુધીનું છે — {month} સુધી {n} વેચાણ. તે અત્યારનું બજાર છે, પૂરું થયેલું વર્ષ નહીં.", pa: "ਡੈਸ਼ ਵਾਲਾ ਹਿੱਸਾ {year} ਹੁਣ ਤੱਕ ਦਾ ਹੈ — {month} ਤੱਕ {n} ਵਿਕਰੀਆਂ। ਇਹ ਹੁਣ ਦਾ ਬਾਜ਼ਾਰ ਹੈ, ਪੂਰਾ ਸਾਲ ਨਹੀਂ।", hi: "धारीदार हिस्सा {year} का अब तक का है — {month} तक {n} बिक्री। यह अभी का बाज़ार है, पूरा वर्ष नहीं।" },
  "strend.ytdNoteNoMonth": { en: "The dashed step is {year} so far — {n} sales. It is where the market is now, not a finished year.", zh: "虚线段为 {year} 年至今——共 {n} 宗成交。它反映当前市场，而非完整年度。", ta: "புள்ளியிட்ட படி {year} இதுவரை — {n} விற்பனைகள். இது இப்போதைய சந்தை, முடிந்த ஆண்டு அல்ல.", gu: "ડૅશવાળું પગથિયું {year} અત્યાર સુધીનું છે — {n} વેચાણ. તે અત્યારનું બજાર છે, પૂરું થયેલું વર્ષ નહીં.", pa: "ਡੈਸ਼ ਵਾਲਾ ਹਿੱਸਾ {year} ਹੁਣ ਤੱਕ ਦਾ ਹੈ — {n} ਵਿਕਰੀਆਂ। ਇਹ ਹੁਣ ਦਾ ਬਾਜ਼ਾਰ ਹੈ, ਪੂਰਾ ਸਾਲ ਨਹੀਂ।", hi: "धारीदार हिस्सा {year} का अब तक का है — {n} बिक्री। यह अभी का बाज़ार है, पूरा वर्ष नहीं।" },
  ...
  "strend.source": { en: "Hover any point for detail", zh: "悬停任一点查看详情", ta: "விவரத்திற்கு எந்த புள்ளியிலும் hover செய்யவும்", gu: "વિગત માટે કોઈપણ બિંદુ પર હોવર કરો", pa: "ਵੇਰਵੇ ਲਈ ਕਿਸੇ ਵੀ ਬਿੰਦੂ 'ਤੇ ਹੋਵਰ ਕਰੋ", hi: "विवरण के लिए किसी भी बिंदु पर होवर करें" },
  ...
  "hd.topUnderpriced": { en: "TOP 3 UNDERPRICED", zh: "最低估的三套", ta: "குறைவிலை டாப் 3", gu: "ટોચના 3 ઓછી કિંમતના", pa: "ਚੋਟੀ ਦੇ 3 ਘੱਟ ਕੀਮਤ", hi: "शीर्ष 3 कम कीमत" },
  "hd.topSubdividable": { en: "TOP 3 SUBDIVIDABLE", zh: "最佳三块可分割地", ta: "பிரிக்கக்கூடிய டாப் 3", gu: "ટોચની 3 વિભાજ્ય", pa: "ਚੋਟੀ ਦੀਆਂ 3 ਵੰਡਣਯੋਗ", hi: "शीर्ष 3 विभाज्य" },
  "hd.netGain": { en: "MODELLED NET GAIN", zh: "模型估算净收益", ta: "நிகர ஆதாயம்", gu: "ચોખ્ખો નફો", pa: "ਸ਼ੁੱਧ ਲਾਭ", hi: "शुद्ध लाभ" },
  "hd.extraLots": { en: "+{n} lots", zh: "+{n} 块地", ta: "+{n} இடங்கள்", gu: "+{n} પ્લોટ", pa: "+{n} ਪਲਾਟ", hi: "+{n} प्लॉट" },
  "hd.topNone": { en: "Nothing here right now", zh: "暂无内容", ta: "இப்போது எதுவும் இல்லை", gu: "અત્યારે કંઈ નથી", pa: "ਹੁਣ ਇੱਥੇ ਕੁਝ ਨਹੀਂ", hi: "अभी यहाँ कुछ नहीं" },
  "adm.edit": { en: "Edit", zh: "编辑", ta: "திருத்து", gu: "સંપાદિત કરો", pa: "ਸੋਧੋ", hi: "संपादित करें" },
  "adm.save": { en: "Save", zh: "保存", ta: "சேமி", gu: "સાચવો", pa: "ਸੰਭਾਲੋ", hi: "सहेजें" },
  "adm.saving": { en: "Saving…", zh: "保存中…", ta: "சேமிக்கிறது…", gu: "સાચવી રહ્યું છે…", pa: "ਸੰਭਾਲ ਰਿਹਾ ਹੈ…", hi: "सहेजा जा रहा है…" },
  "adm.delete": { en: "Delete", zh: "删除", ta: "நீக்கு", gu: "કાઢી નાખો", pa: "ਮਿਟਾਓ", hi: "हटाएं" },
  "adm.deleteConfirm": { en: "Delete {email}? This cannot be undone.", zh: "删除 {email}？此操作无法撤销。", ta: "{email} ஐ நீக்கவா? இதை மீட்டெடுக்க முடியாது.", gu: "{email} કાઢી નાખવું? આ પાછું લાવી શકાતું નથી.", pa: "{email} ਮਿਟਾਉਣਾ ਹੈ? ਇਹ ਵਾਪਸ ਨਹੀਂ ਕੀਤਾ ਜਾ ਸਕਦਾ।", hi: "{email} हटाएं? इसे पूर्ववत नहीं किया जा सकता।" },
  "adm.setPassword": { en: "Set password", zh: "设置密码", ta: "கடவுச்சொல்லை அமை", gu: "પાસવર્ડ સેટ કરો", pa: "ਪਾਸਵਰਡ ਸੈੱਟ ਕਰੋ", hi: "पासवर्ड सेट करें" },
  "adm.newPassword": { en: "New password", zh: "新密码", ta: "புதிய கடவுச்சொல்", gu: "નવો પાસવર્ડ", pa: "ਨਵਾਂ ਪਾਸਵਰਡ", hi: "नया पासवर्ड" },
  "adm.passwordSet": { en: "Password updated — tell them the new one", zh: "密码已更新——请告知对方", ta: "கடவுச்சொல் புதுப்பிக்கப்பட்டது — அவர்களிடம் சொல்லுங்கள்", gu: "પાસવર્ડ અપડેટ થયો — તેમને જણાવો", pa: "ਪਾਸਵਰਡ ਅੱਪਡੇਟ ਹੋਇਆ — ਉਹਨਾਂ ਨੂੰ ਦੱਸੋ", hi: "पासवर्ड बदला गया — उन्हें बताएं" },
  ...
  "adm.tmTitle": { en: "Trade Me sales export", zh: "Trade Me 成交数据", ta: "Trade Me விற்பனை ஏற்றுமதி", gu: "Trade Me વેચાણ નિકાસ", pa: "Trade Me ਵਿਕਰੀ ਨਿਰਯਾਤ", hi: "Trade Me बिक्री निर्यात" },
  "adm.tmSub": { en: "Fills gaps in properties we already hold — floor area, land area, council valuation, ownership type — matched on address. Adds no properties and overwrites nothing. Trade Me's own figure is stored for display only and never enters a valuation.", zh: "为已有房产补全缺失字段——建筑面积、土地面积、政府估价、产权类型——按地址匹配。不新增房产，不覆盖已有数据。Trade Me 的估值仅作展示，绝不参与估价。", ta: "நாம் ஏற்கனவே வைத்திருக்கும் சொத்துகளின் இடைவெளிகளை நிரப்புகிறது — தள பரப்பு, நில பரப்பு, கவுன்சில் மதிப்பீடு, உரிமை வகை — முகவரி மூலம் பொருத்தப்படுகிறது. புதிய சொத்துகள் சேர்க்கப்படுவதில்லை, எதுவும் மேலெழுதப்படுவதில்லை. Trade Me இன் எண் காட்சிக்கு மட்டுமே.", gu: "અમારી પાસે પહેલેથી હોય તેવી મિલકતોમાં ખૂટતી વિગતો ભરે છે — ફ્લોર એરિયા, જમીન, કાઉન્સિલ મૂલ્યાંકન, માલિકી પ્રકાર — સરનામાં પર મેચ કરીને. કોઈ મિલકત ઉમેરાતી નથી, કશું બદલાતું નથી. Trade Me નો આંકડો ફક્ત દર્શાવવા માટે.", pa: "ਸਾਡੇ ਕੋਲ ਪਹਿਲਾਂ ਤੋਂ ਮੌਜੂਦ ਜਾਇਦਾਦਾਂ ਦੀਆਂ ਖਾਲੀ ਥਾਵਾਂ ਭਰਦਾ ਹੈ — ਫਲੋਰ ਏਰੀਆ, ਜ਼ਮੀਨ, ਕੌਂਸਲ ਮੁਲਾਂਕਣ, ਮਾਲਕੀ ਕਿਸਮ — ਪਤੇ ਨਾਲ ਮਿਲਾ ਕੇ। ਕੋਈ ਜਾਇਦਾਦ ਨਹੀਂ ਜੁੜਦੀ, ਕੁਝ ਨਹੀਂ ਬਦਲਦਾ। Trade Me ਦਾ ਅੰਕੜਾ ਸਿਰਫ਼ ਵਿਖਾਉਣ ਲਈ।", hi: "हमारे पास पहले से मौजूद संपत्तियों की कमियाँ भरता है — फ़्लोर एरिया, ज़मीन, काउंसिल मूल्यांकन, स्वामित्व प्रकार — पते से मिलान करके। कोई संपत्ति नहीं जुड़ती, कुछ नहीं बदलता। Trade Me का आँकड़ा केवल दिखाने के लिए।" },
  "adm.tmChoose": { en: "Choose CSV", zh: "选择 CSV", ta: "CSV தேர்ந்தெடு", gu: "CSV પસંદ કરો", pa: "CSV ਚੁਣੋ", hi: "CSV चुनें" },
  "adm.tmCheck": { en: "Check first", zh: "先检查", ta: "முதலில் சரிபார்", gu: "પહેલા તપાસો", pa: "ਪਹਿਲਾਂ ਜਾਂਚੋ", hi: "पहले जाँचें" },
  "adm.tmChecking": { en: "Checking…", zh: "检查中…", ta: "சரிபார்க்கிறது…", gu: "તપાસી રહ્યું છે…", pa: "ਜਾਂਚ ਰਿਹਾ ਹੈ…", hi: "जाँच रहे हैं…" },
  "adm.tmFill": { en: "Fill gaps", zh: "补全缺失", ta: "இடைவெளிகளை நிரப்பு", gu: "ખાલી જગ્યા ભરો", pa: "ਖਾਲੀ ਥਾਵਾਂ ਭਰੋ", hi: "कमियाँ भरें" },
  "adm.tmFilling": { en: "Filling…", zh: "补全中…", ta: "நிரப்புகிறது…", gu: "ભરી રહ્યું છે…", pa: "ਭਰ ਰਿਹਾ ਹੈ…", hi: "भर रहे हैं…" },
  "adm.tmWouldFill": { en: "What this would fill", zh: "将会补全的内容", ta: "இது நிரப்பும் விவரங்கள்", gu: "આ શું ભરશે", pa: "ਇਹ ਕੀ ਭਰੇਗਾ", hi: "यह क्या भरेगा" },
  "adm.tmFilled": { en: "Filled", zh: "已补全", ta: "நிரப்பப்பட்டது", gu: "ભરાયું", pa: "ਭਰ ਦਿੱਤਾ", hi: "भर दिया" },
  "adm.tmMatched": { en: "{matched} of our properties matched from {seen} rows · {unmatched} of theirs we hold nothing for", zh: "从 {seen} 行中匹配到我们的 {matched} 处房产 · 其中 {unmatched} 行我们没有对应记录", ta: "{seen} வரிசைகளில் இருந்து நமது {matched} சொத்துகள் பொருந்தின · {unmatched} க்கு நம்மிடம் எதுவும் இல்லை", gu: "{seen} પંક્તિઓમાંથી અમારી {matched} મિલકતો મેચ થઈ · {unmatched} માટે અમારી પાસે કંઈ નથી", pa: "{seen} ਕਤਾਰਾਂ ਵਿੱਚੋਂ ਸਾਡੀਆਂ {matched} ਜਾਇਦਾਦਾਂ ਮਿਲੀਆਂ · {unmatched} ਲਈ ਸਾਡੇ ਕੋਲ ਕੁਝ ਨਹੀਂ", hi: "{seen} पंक्तियों में से हमारी {matched} संपत्तियाँ मिलीं · {unmatched} के लिए हमारे पास कुछ नहीं" },
  "adm.tmNothing": { en: "Nothing to fill — every matched property already has these fields.", zh: "无需补全——匹配到的房产均已具备这些字段。", ta: "நிரப்ப எதுவும் இல்லை — பொருந்திய அனைத்து சொத்துகளிலும் இந்த விவரங்கள் உள்ளன.", gu: "ભરવા જેવું કંઈ નથી — મેચ થયેલી બધી મિલકતોમાં આ વિગતો છે.", pa: "ਭਰਨ ਲਈ ਕੁਝ ਨਹੀਂ — ਸਾਰੀਆਂ ਮਿਲੀਆਂ ਜਾਇਦਾਦਾਂ ਕੋਲ ਇਹ ਵੇਰਵੇ ਹਨ।", hi: "भरने को कुछ नहीं — मिली सभी संपत्तियों में ये विवरण पहले से हैं।" },
  "adm.tmValuations": { en: "{n} Trade Me figures stored for display", zh: "已保存 {n} 条 Trade Me 估值用于展示", ta: "காட்சிக்காக {n} Trade Me எண்கள் சேமிக்கப்பட்டன", gu: "દર્શાવવા માટે {n} Trade Me આંકડા સાચવ્યા", pa: "ਵਿਖਾਉਣ ਲਈ {n} Trade Me ਅੰਕੜੇ ਸੰਭਾਲੇ", hi: "दिखाने के लिए {n} Trade Me आँकड़े सहेजे" },
  "adm.tmConflicts": { en: "Same sale, different date", zh: "同一笔成交，日期不同", ta: "ஒரே விற்பனை, வேறு தேதி", gu: "એક જ વેચાણ, અલગ તારીખ", pa: "ਇੱਕੋ ਵਿਕਰੀ, ਵੱਖਰੀ ਤਾਰੀਖ", hi: "एक ही बिक्री, अलग तारीख" },
  "adm.tmConflictsSub": { en: "Their date looks like the agreement, ours the settlement. Listed so a difference of weeks does not turn into two sales of one house.", zh: "他们的日期像是签约日，我们的像是交割日。列出以免相差数周被当作同一房产的两笔成交。", ta: "அவர்களின் தேதி ஒப்பந்தம் போலவும், நம்முடையது தீர்வு போலவும் தெரிகிறது. வாரங்கள் வித்தியாசம் ஒரே வீட்டின் இரண்டு விற்பனைகளாக மாறாமல் இருக்க பட்டியலிடப்பட்டுள்ளது.", gu: "તેમની તારીખ કરાર જેવી, અમારી સેટલમેન્ટ જેવી. અઠવાડિયાનો ફરક એક જ ઘરના બે વેચાણ ન બની જાય તે માટે યાદી.", pa: "ਉਹਨਾਂ ਦੀ ਤਾਰੀਖ ਸਮਝੌਤੇ ਵਰਗੀ, ਸਾਡੀ ਸੈਟਲਮੈਂਟ ਵਰਗੀ। ਹਫ਼ਤਿਆਂ ਦਾ ਫ਼ਰਕ ਇੱਕੋ ਘਰ ਦੀਆਂ ਦੋ ਵਿਕਰੀਆਂ ਨਾ ਬਣ ਜਾਵੇ।", hi: "उनकी तारीख अनुबंध जैसी, हमारी सेटलमेंट जैसी। हफ़्तों का फ़र्क एक ही घर की दो बिक्री न बन जाए, इसलिए सूचीबद्ध।" },
  ...
  // "archived" reads as "these houses are gone". They are not: a superseded
  // FILE is not superseded LISTINGS. Everything still advertised was carried
  // into the current load; a listing leaves only when the link check finds its
  // advertisement gone.
  "adm.superseded": { en: "superseded", zh: "已被取代", ta: "மாற்றப்பட்டது", gu: "બદલાયેલ", pa: "ਬਦਲਿਆ ਗਿਆ", hi: "प्रतिस्थापित" },
  // A file that has been uploaded and not yet published. It has not been
  // replaced by anything — it is waiting on a button. Calling that "superseded"
  // told the reader the opposite of what to do about it.
  "adm.notPublished": { en: "not published yet", zh: "尚未发布", ta: "இன்னும் வெளியிடப்படவில்லை", gu: "હજુ પ્રકાશિત નથી", pa: "ਅਜੇ ਪ੍ਰਕਾਸ਼ਿਤ ਨਹੀਂ", hi: "अभी प्रकाशित नहीं" },
  "adm.notPublishedNote": {
    en: "uploaded and waiting — publish to put it live",
    zh: "已上传，等待发布即可上线",
    ta: "பதிவேற்றப்பட்டு காத்திருக்கிறது — வெளியிட்டால் நேரலைக்கு வரும்",
    gu: "અપલોડ થયું અને રાહ જુએ છે — લાઇવ કરવા પ્રકાશિત કરો",
    pa: "ਅੱਪਲੋਡ ਹੋ ਗਿਆ ਤੇ ਉਡੀਕ ਵਿੱਚ — ਲਾਈਵ ਕਰਨ ਲਈ ਪ੍ਰਕਾਸ਼ਿਤ ਕਰੋ",
    hi: "अपलोड हो गया, प्रतीक्षा में — लाइव करने के लिए प्रकाशित करें",
  },
  "adm.supersededNote": {
    en: "its still-advertised listings were carried into the current load",
    zh: "其仍在挂牌的房源已转入当前批次",
    ta: "இன்னும் விளம்பரத்தில் உள்ள பட்டியல்கள் தற்போதைய பதிவேற்றத்திற்கு மாற்றப்பட்டன",
    gu: "હજુ જાહેરાતમાં રહેલી લિસ્ટિંગ વર્તમાન લોડમાં લઈ જવાઈ",
    pa: "ਅਜੇ ਵੀ ਇਸ਼ਤਿਹਾਰ ਵਿੱਚ ਮੌਜੂਦ ਲਿਸਟਿੰਗਾਂ ਮੌਜੂਦਾ ਲੋਡ ਵਿੱਚ ਲੈ ਜਾਈਆਂ ਗਈਆਂ",
    hi: "अब भी विज्ञापित लिस्टिंग वर्तमान लोड में ले ली गईं",
  },
  ...
  "va.addBedroom": { en: "Increase to {n} bedrooms", zh: "增加第 {n} 间卧室", ta: "{n}வது படுக்கையறை சேர்", gu: "{n}મો બેડરૂમ ઉમેરો", pa: "{n}ਵਾਂ ਬੈੱਡਰੂਮ ਜੋੜੋ", hi: "{n}वाँ बेडरूम जोड़ें" },
  "va.addBathroom": { en: "Increase to {n} bathrooms", zh: "增加第 {n} 间浴室", ta: "{n}வது குளியலறை சேர்", gu: "{n}મો બાથરૂમ ઉમેરો", pa: "{n}ਵਾਂ ਬਾਥਰੂਮ ਜੋੜੋ", hi: "{n}वाँ बाथरूम जोड़ें" },
  ...
  "prop.buyPriceBasedOn": { en: "Our estimated buy price is based on {basis}", zh: "我们的预估买入价基于{basis}", ta: "எங்கள் மதிப்பிட்ட வாங்கும் விலை {basis} அடிப்படையில்", gu: "અમારો અંદાજિત ખરીદ ભાવ {basis} પર આધારિત છે", pa: "ਸਾਡਾ ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ {basis} 'ਤੇ ਆਧਾਰਿਤ ਹੈ", hi: "हमारा अनुमानित खरीद मूल्य {basis} पर आधारित है" },
  ...
  // Shown in place of a price on a listing that has none, because it is being
  // sold a way that does not have one. See askingText in lib/format.ts.
  "filter.zonePlaceholder": { en: "All zones", zh: "所有分区", ta: "அனைத்து மண்டலங்கள்", gu: "બધા ઝોન", pa: "ਸਾਰੇ ਜ਼ੋਨ", hi: "सभी ज़ोन" },
  "price.guide": { en: "Enquiries over {v}", zh: "价格咨询超过 {v}", ta: "{v} க்கு மேல் விசாரணைகள்", gu: "{v} થી વધુ પૂછપરછ", pa: "{v} ਤੋਂ ਵੱਧ ਪੁੱਛਗਿੱਛ", hi: "{v} से अधिक पूछताछ" },
  "price.auction": { en: "Auction", zh: "拍卖", ta: "ஏலம்", gu: "હરાજી", pa: "ਨੀਲਾਮੀ", hi: "नीलामी" },
  "price.tender": { en: "Tender", zh: "招标", ta: "டெண்டர்", gu: "ટેન્ડર", pa: "ਟੈਂਡਰ", hi: "निविदा" },
  "price.negotiation": { en: "By negotiation", zh: "面议", ta: "பேச்சுவார்த்தை மூலம்", gu: "વાટાઘાટથી", pa: "ਗੱਲਬਾਤ ਰਾਹੀਂ", hi: "बातचीत द्वारा" },
