...
const STRINGS: Dict = {
  ...
  "nav.askApex": { en: "Ask Apex", zh: "问 Apex", ta: "Apex இடம் கேளுங்கள்", gu: "Apex ને પૂછો", pa: "Apex ਤੋਂ ਪੁੱਛੋ", hi: "Apex से पूछें" },
  ...
  "nav.auctions": { en: "Auctions", zh: "拍卖", ta: "ஏலங்கள்", gu: "હરાજી", pa: "ਨੀਲਾਮੀ", hi: "नीलामी" },
  ...
  // --- auctions lane (no-price listings) ---
  "auc.kicker": { en: "No-price lane", zh: "无标价专区", ta: "விலையில்லா பட்டியல்", gu: "કિંમત વગરની લેન", pa: "ਬਿਨਾਂ ਕੀਮਤ ਲੇਨ", hi: "बिना-कीमत लेन" },
  "auc.title": { en: "Auctions & by-negotiation", zh: "拍卖与议价", ta: "ஏலம் & பேச்சுவார்த்தை", gu: "હરાજી અને વાટાઘાટ", pa: "ਨੀਲਾਮੀ ਅਤੇ ਗੱਲਬਾਤ", hi: "नीलामी और बातचीत" },
  "auc.blurb": {
    en: "Listings with no asking price. There's no margin-vs-list to show, so we give you our independent estimate, a comps-based buy ceiling (the most you should bid), and the headroom between them. Shown only when three independent signals agree on the value. Ranked by headroom.",
    zh: "无标价房源。没有相对标价的差额可显示，因此我们提供独立估值、基于成交可比的买入上限（你最多应出的价）以及两者之间的空间。仅在三项独立信号一致时显示。按空间排序。",
    ta: "கேட்கும் விலை இல்லாத பட்டியல்கள். பட்டியல்-ஒப்பீட்டு லாபம் காட்ட முடியாது, எனவே எங்கள் சுயமதிப்பீடு, ஒப்பீட்டு அடிப்படையிலான வாங்கும் உச்சவரம்பு (நீங்கள் இடும் அதிகபட்ச விலை), இடையேயுள்ள இடைவெளியைத் தருகிறோம். மூன்று சுயாதீன சமிக்ஞைகள் ஒத்துப்போகும்போது மட்டுமே காட்டப்படும். இடைவெளிப்படி வரிசைப்படுத்தப்பட்டது.",
    gu: "કિંમત વગરની લિસ્ટિંગ. લિસ્ટ-સામે-માર્જિન બતાવી શકાતું નથી, તેથી અમે અમારો સ્વતંત્ર અંદાજ, કોમ્પ્સ આધારિત ખરીદ ટોચમર્યાદા (તમારે વધુમાં વધુ બોલી લગાવવી જોઈએ) અને તેમની વચ્ચેની જગ્યા આપીએ છીએ. ત્રણ સ્વતંત્ર સંકેતો સંમત થાય ત્યારે જ બતાવાય. હેડરૂમ પ્રમાણે ક્રમબદ્ધ.",
    pa: "ਬਿਨਾਂ ਕੀਮਤ ਵਾਲੀਆਂ ਲਿਸਟਿੰਗਾਂ। ਲਿਸਟ-ਬਨਾਮ-ਮਾਰਜਿਨ ਨਹੀਂ ਦਿਖਾ ਸਕਦੇ, ਇਸ ਲਈ ਅਸੀਂ ਆਪਣਾ ਸੁਤੰਤਰ ਅੰਦਾਜ਼ਾ, ਕੌਂਪਸ-ਆਧਾਰਿਤ ਖਰੀਦ ਸੀਮਾ (ਵੱਧ ਤੋਂ ਵੱਧ ਬੋਲੀ) ਅਤੇ ਵਿਚਕਾਰਲੀ ਥਾਂ ਦਿੰਦੇ ਹਾਂ। ਤਿੰਨ ਸੁਤੰਤਰ ਸੰਕੇਤ ਸਹਿਮਤ ਹੋਣ 'ਤੇ ਹੀ ਦਿਖਾਈ ਦਿੰਦੀ ਹੈ। ਹੈਡਰੂਮ ਅਨੁਸਾਰ ਕ੍ਰਮਬੱਧ।",
    hi: "बिना कीमत वाली लिस्टिंग। लिस्ट-बनाम-मार्जिन नहीं दिखा सकते, इसलिए हम अपना स्वतंत्र अनुमान, कॉम्प्स-आधारित खरीद सीमा (अधिकतम बोली) और उनके बीच की जगह देते हैं। तीन स्वतंत्र संकेत सहमत होने पर ही दिखती है। हेडरूम के अनुसार क्रमित।",
  },
  "auc.estimate": { en: "Our estimate", zh: "我们的估值", ta: "எங்கள் மதிப்பீடு", gu: "અમારો અંદાજ", pa: "ਸਾਡਾ ਅੰਦਾਜ਼ਾ", hi: "हमारा अनुमान" },
  "auc.buyCeiling": { en: "Buy ceiling", zh: "买入上限", ta: "வாங்கும் உச்சவரம்பு", gu: "ખરીદ ટોચમર્યાદા", pa: "ਖਰੀਦ ਸੀਮਾ", hi: "खरीद सीमा" },
  "auc.headroom": { en: "Headroom", zh: "空间", ta: "இடைவெளி", gu: "હેડરૂમ", pa: "ਹੈਡਰੂਮ", hi: "हेडरूम" },
  "auc.headroomNote": { en: "estimate − ceiling", zh: "估值 − 上限", ta: "மதிப்பீடு − உச்சவரம்பு", gu: "અંદાજ − ટોચમર્યાદા", pa: "ਅੰਦਾਜ਼ਾ − ਸੀਮਾ", hi: "अनुमान − सीमा" },
  "auc.biggestHeadroom": { en: "Most headroom right now", zh: "当前空间最大", ta: "இப்போது அதிக இடைவெளி", gu: "અત્યારે સૌથી વધુ હેડરૂમ", pa: "ਹੁਣ ਸਭ ਤੋਂ ਵੱਧ ਹੈਡਰੂਮ", hi: "अभी सबसे अधिक हेडरूम" },
  "auc.method": { en: "Sale method", zh: "销售方式", ta: "விற்பனை முறை", gu: "વેચાણ પદ્ધતિ", pa: "ਵਿਕਰੀ ਵਿਧੀ", hi: "बिक्री विधि" },
  "auc.searchPlaceholder": { en: "Search address or suburb…", zh: "搜索地址或区域…", ta: "முகவரி அல்லது புறநகர் தேடு…", gu: "સરનામું અથવા ઉપનગર શોધો…", pa: "ਪਤਾ ਜਾਂ ਉਪਨਗਰ ਖੋਜੋ…", hi: "पता या उपनगर खोजें…" },
  "auc.loading": { en: "Loading auctions…", zh: "正在加载拍卖…", ta: "ஏலங்கள் ஏற்றுகிறது…", gu: "હરાજી લોડ થઈ રહી છે…", pa: "ਨੀਲਾਮੀ ਲੋਡ ਹੋ ਰਹੀ ਹੈ…", hi: "नीलामी लोड हो रही है…" },
  "auc.error": { en: "Couldn't load the auctions lane.", zh: "无法加载拍卖专区。", ta: "ஏலப் பட்டியலை ஏற்ற முடியவில்லை.", gu: "હરાજી લેન લોડ થઈ શકી નહીં.", pa: "ਨੀਲਾਮੀ ਲੇਨ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੀ।", hi: "नीलामी लेन लोड नहीं हो सकी।" },
  "auc.empty": { en: "No no-price listings clear the confidence gate in this batch yet.", zh: "本批次暂无无标价房源通过置信门槛。", ta: "இந்த தொகுப்பில் எந்த விலையில்லா பட்டியலும் நம்பகத்தன்மை வாயிலைத் தாண்டவில்லை.", gu: "આ બેચમાં કોઈ કિંમત વગરની લિસ્ટિંગ હજી કોન્ફિડન્સ ગેટ પાર કરતી નથી.", pa: "ਇਸ ਬੈਚ ਵਿੱਚ ਕੋਈ ਬਿਨਾਂ-ਕੀਮਤ ਲਿਸਟਿੰਗ ਅਜੇ ਭਰੋਸਾ ਗੇਟ ਪਾਰ ਨਹੀਂ ਕਰਦੀ।", hi: "इस बैच में कोई बिना-कीमत लिस्टिंग अभी कॉन्फिडेंस गेट पार नहीं करती।" },
  "auc.type.auction": { en: "Auction", zh: "拍卖", ta: "ஏலம்", gu: "હરાજી", pa: "ਨੀਲਾਮੀ", hi: "नीलामी" },
  "auc.type.tender": { en: "Tender", zh: "招标", ta: "டெண்டர்", gu: "ટેન્ડર", pa: "ਟੈਂਡਰ", hi: "टेंडर" },
  "auc.type.negotiation": { en: "By negotiation", zh: "议价", ta: "பேச்சுவார்த்தை", gu: "વાટાઘાટથી", pa: "ਗੱਲਬਾਤ ਰਾਹੀਂ", hi: "बातचीत से" },
  "auc.type.unknown": { en: "No price", zh: "无标价", ta: "விலை இல்லை", gu: "કિંમત નથી", pa: "ਬਿਨਾਂ ਕੀਮਤ", hi: "बिना कीमत" },
  "auc.type.fixed": { en: "No price", zh: "无标价", ta: "விலை இல்லை", gu: "કિંમત નથી", pa: "ਬਿਨਾਂ ਕੀਮਤ", hi: "बिना कीमत" },

  // --- ask ollie ---
  "ask.eyebrow": { en: "ANALYST", zh: "分析师", ta: "பகுப்பாய்வாளர்", gu: "વિશ્લેષક", pa: "ਵਿਸ਼ਲੇਸ਼ਕ", hi: "विश्लेषक" },
  "ask.title": { en: "Ask Apex", zh: "问 Apex", ta: "Apex இடம் கேளுங்கள்", gu: "Apex ને પૂછો", pa: "Apex ਤੋਂ ਪੁੱਛੋ", hi: "Apex से पूछें" },
  "ask.blurb": {
  ...
  "ask.thinking": { en: "Apex is thinking…", zh: "Apex 正在思考…", ta: "Apex சிந்திக்கிறது…", gu: "Apex વિચારી રહ્યું છે…", pa: "Apex ਸੋਚ ਰਿਹਾ ਹੈ…", hi: "Apex सोच रहा है…" },
  ...
  "prop.sellEstimateRow": { en: "Sell estimate", zh: "预估售价", ta: "விற்பனை மதிப்பீடு", gu: "વેચાણ અંદાજ", pa: "ਵਿਕਰੀ ਅੰਦਾਜ਼ਾ", hi: "बिक्री अनुमान" },
  ...
  "prop.marginVsBuy": { en: "Margin vs est buy price", zh: "对比预估买入价差价", ta: "மதிப்பிட்ட வாங்கும் விலைக்கு எதிராக வித்தியாசம்", gu: "અંદાજિત ખરીદ કિંમત સામે તફાવત", pa: "ਅਨੁਮਾਨਿਤ ਖਰੀਦ ਮੁੱਲ ਦੇ ਮੁਕਾਬਲੇ ਅੰਤਰ", hi: "अनुमानित खरीद मूल्य की तुलना में अंतर" },
  ...
  "prop.lastSoldNoPrice": { en: "Last sold on {date} — price not recorded.", zh: "上次成交于 {date}——未记录价格。", ta: "கடைசியாக {date} அன்று விற்பனை — விலை பதிவு இல்லை.", gu: "છેલ્લે {date} ના રોજ વેચાયું — કિંમત નોંધાયેલ નથી.", pa: "ਪਿਛਲੀ ਵਾਰ {date} ਨੂੰ ਵਿਕਿਆ — ਕੀਮਤ ਦਰਜ ਨਹੀਂ।", hi: "पिछली बार {date} को बिका — कीमत दर्ज नहीं।" },
  "prop.noRecordedSales": { en: "No sale on record for this property.", zh: "该房产无成交记录。", ta: "இந்தச் சொத்துக்கு விற்பனை பதிவு இல்லை.", gu: "આ મિલકત માટે કોઈ વેચાણ નોંધ નથી.", pa: "ਇਸ ਜਾਇਦਾਦ ਲਈ ਕੋਈ ਵਿਕਰੀ ਰਿਕਾਰਡ ਨਹੀਂ।", hi: "इस संपत्ति के लिए कोई बिक्री रिकॉर्ड नहीं।" },
  ...
  "today.intro": { en: "Apex scanned {n} live listings. Here's where the opportunity is right now.", zh: "Apex 扫描了 {n} 条在售房源。以下是当前的机会所在。", ta: "Apex {n} நேரடி பட்டியல்களை ஸ்கேன் செய்தது. இப்போது வாய்ப்புகள் இங்கே.", gu: "Apex એ {n} લાઇવ લિસ્ટિંગ સ્કેન કરી. અત્યારે તક અહીં છે.", pa: "Apex ਨੇ {n} ਲਾਈਵ ਲਿਸਟਿੰਗਾਂ ਸਕੈਨ ਕੀਤੀਆਂ। ਹੁਣ ਮੌਕੇ ਇੱਥੇ ਹਨ।", hi: "Apex ने {n} लाइव लिस्टिंग स्कैन कीं। अभी अवसर यहाँ हैं।" },
  ...
  // --- buyers agent ---
  "agent.title": { en: "Talk to an Apex buyer's agent", zh: "联系 Apex 买方经纪", ta: "Apex வாங்குபவர் முகவரிடம் பேசுங்கள்", gu: "Apex ખરીદદાર એજન્ટ સાથે વાત કરો", pa: "Apex ਖਰੀਦਦਾਰ ਏਜੰਟ ਨਾਲ ਗੱਲ ਕਰੋ", hi: "Apex खरीदार एजेंट से बात करें" },
  ...
  "ptable.allAreas": { en: "District", zh: "行政区", hi: "ज़िला", pa: "ਜ਼ਿਲ੍ਹਾ", gu: "જિલ્લો", ta: "மாவட்டம்" },
  "ptable.anyBeds": { en: "Any beds", zh: "不限卧室", hi: "कोई भी बेडरूम", pa: "ਕੋਈ ਵੀ ਬੈੱਡਰੂਮ", gu: "કોઈપણ બેડરૂમ", ta: "எந்த படுக்கையறையும்" },
  "filter.suburbPlaceholder": { en: "Suburb", zh: "郊区", hi: "उपनगर", pa: "ਉਪਨਗਰ", gu: "ઉપનગર", ta: "புறநகர்" },
  "filter.clearSuburb": { en: "Clear suburb", zh: "清除郊区", hi: "उपनगर हटाएँ", pa: "ਉਪਨਗਰ ਸਾਫ਼ ਕਰੋ", gu: "ઉપનગર સાફ કરો", ta: "புறநகரை அழி" },
  ...
  "subcalc.lessBuildServices": { en: "Less build + services", zh: "减：建造 + 基础设施", ta: "கழி கட்டுமானம் + வசதிகள்", gu: "બાદ કરો બાંધકામ + સુવિધાઓ", pa: "ਘਟਾਓ ਉਸਾਰੀ + ਸਹੂਲਤਾਂ", hi: "घटाएँ निर्माण + सुविधाएँ" },
  ...
  "subcalc.terraceBuildValue": { en: "Build {n} terraces", zh: "建造 {n} 栋联排", hi: "{n} टैरेस बनाएँ", pa: "{n} ਟੈਰੇਸ ਬਣਾਓ", gu: "{n} ટેરેસ બનાવો", ta: "{n} டெரஸ் கட்டு" },
  "subcalc.terraceDemolishValue": { en: "Demolish & build {n} terraces", zh: "拆除并建造 {n} 栋联排", hi: "गिराकर {n} टैरेस बनाएँ", pa: "ਢਾਹ ਕੇ {n} ਟੈਰੇਸ ਬਣਾਓ", gu: "તોડીને {n} ટેરેસ બનાવો", ta: "இடித்து {n} டெரஸ் கட்டு" },
  "subcalc.terracesSold": { en: "{n} terraces sold @ {each} each", zh: "售出 {n} 栋联排，每栋 {each}", hi: "{n} टैरेस बिके @ {each} प्रत्येक", pa: "{n} ਟੈਰੇਸ ਵਿਕੇ @ {each} ਹਰੇਕ", gu: "{n} ટેરેસ વેચાયા @ {each} દરેક", ta: "{n} டெரஸ் விற்பனை @ {each} ஒவ்வொன்றும்" },
  ...
  "wish.blurb": { en: "Save the searches you care about — an area, a budget, a type, or development sites under a buy price. Apex flags new listings and price drops that match, each time the market refreshes.", zh: "保存你关心的搜索条件——区域、预算、类型，或低于某买入价的开发地块。每次市场更新时，Apex 会标记符合条件的新房源与降价。", hi: "अपनी पसंदीदा खोजें सहेजें — क्षेत्र, बजट, प्रकार, या किसी खरीद मूल्य से कम के विकास स्थल। हर बार बाज़ार ताज़ा होने पर Apex मेल खाती नई लिस्टिंग और कीमत गिरावट को चिह्नित करता है।", pa: "ਆਪਣੀਆਂ ਪਸੰਦੀਦਾ ਖੋਜਾਂ ਸੰਭਾਲੋ — ਖੇਤਰ, ਬਜਟ, ਕਿਸਮ, ਜਾਂ ਕਿਸੇ ਖਰੀਦ ਮੁੱਲ ਤੋਂ ਘੱਟ ਵਿਕਾਸ ਥਾਂਵਾਂ। ਹਰ ਵਾਰ ਬਾਜ਼ਾਰ ਤਾਜ਼ਾ ਹੋਣ ਤੇ Apex ਮੇਲ ਖਾਂਦੀਆਂ ਨਵੀਆਂ ਲਿਸਟਿੰਗਾਂ ਅਤੇ ਕੀਮਤ ਗਿਰਾਵਟਾਂ ਨੂੰ ਚਿੰਨ੍ਹਿਤ ਕਰਦਾ ਹੈ।", gu: "તમારી પસંદની શોધ સાચવો — વિસ્તાર, બજેટ, પ્રકાર, અથવા કોઈ ખરીદ ભાવથી ઓછા વિકાસ સ્થળો. દર વખતે બજાર તાજું થાય ત્યારે Apex મેળ ખાતી નવી લિસ્ટિંગ અને ભાવ ઘટાડા ચિહ્નિત કરે છે.", ta: "உங்களுக்கு முக்கியமான தேடல்களைச் சேமியுங்கள் — பகுதி, பட்ஜெட், வகை, அல்லது ஒரு வாங்கும் விலைக்குக் கீழ் மேம்பாட்டு இடங்கள். சந்தை புதுப்பிக்கப்படும் ஒவ்வொரு முறையும் Apex பொருந்தும் புதிய பட்டியல்களையும் விலை வீழ்ச்சிகளையும் குறிக்கிறது." },
