...
const STRINGS: Dict = {
  ...
  "hd.gemsHint": { en: "across {n} listings · 15%+ uplift over asking, 8+ comps", zh: "覆盖 {n} 条 · 相对要价的估值增幅至少15%，至少8条可比成交", ta: "{n} பட்டியல்களில் · மதிப்பை விட 15%+ குறைவு, 8+ ஒப்பீடு", gu: "{n} લિસ્ટિંગ પર · મૂલ્યથી 15%+ ઓછું, 8+ તુલના", pa: "{n} ਲਿਸਟਿੰਗਾਂ 'ਤੇ · ਮੁੱਲ ਤੋਂ 15%+ ਘੱਟ, 8+ ਤੁਲਨਾ", hi: "{n} लिस्टिंग पर · मूल्य से 15%+ कम, 8+ तुलना" },
  ...
  "hd.marginHint": { en: "across {n} listings · same quality filters as Underpriced", zh: "覆盖 {n} 条 · 与低估房源页面使用相同质量筛选", ta: "{n} பட்டியல்களில் · பலவீன சமிக்ஞைகளும் அடங்கும்", gu: "{n} લિસ્ટિંગ પર · નબળા સંકેત પણ સામેલ", pa: "{n} ਲਿਸਟਿੰਗਾਂ 'ਤੇ · ਕਮਜ਼ੋਰ ਸੰਕੇਤ ਵੀ ਸ਼ਾਮਲ", hi: "{n} लिस्टिंग पर · कमज़ोर संकेत भी शामिल" },
