    ...
    <div className="min-h-screen bg-paper">
      ...
      <section className="max-w-[1200px] mx-auto px-6 pt-24 pb-16">
        ...
        <p className="text-muted mt-6 max-w-2xl text-lg">
          Apex scans every Auckland listing every week, gives each one its own valuation, flags the
      ...
      <section className="max-w-[1200px] mx-auto px-6 pb-24 grid md:grid-cols-3 gap-5">
        <Feature
          ...
          body="Every Auckland listing gets Apex's own valuation, so you can see at a glance what a property is really worth versus what it's listed for."
          color="#2E353D"
        />
        <Feature
